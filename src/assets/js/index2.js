$(function(e) {
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: "New Users",
          borderColor: "rgb(237, 81, 81)",
          borderWidth: "5",
          backgroundColor: "rgb(237, 81, 81, 0.6)",
          data: [20, 20, 47, 20, 49, 20, 50]
        },
        {
          label: "Register Users",
          borderColor: "rgb(156, 49, 223)",
          borderWidth: "5",
          backgroundColor: "rgba(156, 49, 223, 0.6)",
  ...
  gradientStroke2.addColorStop(0, "rgb(156, 49, 223,0.8)");
  var myChart = new Chart(myCanvas, {
    type: "bar",
    data: {
  ...
  new Morris.Donut({
    element: "morrisBar8",
    data: [
      { value: 95, label: "Duplex Houses" },
      { value: 30, label: "2BHK Flats" },
      { value: 45, label: "Apartments" },
      { value: 20, label: "Graden House" }
    ],
    colors: ["#523eaf", "#9c31df", "#00e682", "#ff382b"],
