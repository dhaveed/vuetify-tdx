...
g2 = new Dygraph(document.getElementById("candlechart"), candleData, {
...
// multibar
g4 = new Dygraph(document.getElementById("multibar"), short_data, {
  includeZero: true,
  plotter: multiColumnBarPlotter
});

// Mixed Error Bars and Lines
g5 = new Dygraph(document.getElementById("mixed-error"), NoisyData(), {
  errorBars: true,
  series: {
    A: {
