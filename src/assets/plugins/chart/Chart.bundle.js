          ...
          module.exports = function(Chart) {
            Chart.controllers.bar = Chart.DatasetController.extend({
              ...
              calculateBarIndexPixels: function(datasetIndex, index, ruler) {
                ...
                rightCategorySize =
                  rightSampleSize * options.categoryPercentage;
                fullBarSize =
                  (leftCategorySize + rightCategorySize) / ruler.stackCount;
          ...
          module.exports = function(Chart) {
            ...
            Chart.layoutService = {
              ...
              update: function(chart, width, height) {
                ...
                helpers.each(leftBoxes.concat(rightBoxes), function(
                  verticalBox
                ) {
          ...
          module.exports = function(Chart) {
            ...
            Chart.Title = Element.extend({
              ...
              fit: function() {
                ...
                var minSize = me.minSize;
                var lineCount = helpers.isArray(opts.text)
                  ? opts.text.length
                  : 1;
          ...
          module.exports = function(Chart) {
            ...
            Chart.LinearScaleBase = Chart.Scale.extend({
              ...
              buildTicks: function() {
                ...
                var ticks = (me.ticks = Ticks.generators.linear(
          ...
          module.exports = function(Chart) {
            ...
            var LogarithmicScale = Chart.Scale.extend({
              ...
              buildTicks: function() {
                ...
                var ticks = (me.ticks = Ticks.generators.logarithmic(
                  generationOptions,
                  me
                ));
            ...
            function drawPointLabels(scale) {
              ...
              for (var i = getValueCount(scale) - 1; i >= 0; i--) {
                ...
                if (pointLabelOpts.display) {
                  ...
                  var pointLabelFontColor = valueOrDefault(
            ...
            var TimeScale = Chart.Scale.extend({
              ...
              getLabelForIndex: function(index, datasetIndex) {
                ...
                if (timeOpts.tooltipFormat) {
                  label = momentify(label, timeOpts).format(
