  ...
  function p(q) {
    var p = (g.Toggles = function(c, a) {
      ...
      if ("boolean" === typeof a && c.data("toggles"))
        ...
        for (
          var k = "on drag click width height animate easing type checkbox".split(
              " "
            ),
            b = {},
            l = 0;
        ...
        var v = (g.toggle = function(b, e, A) {
            f !== b &&
              ((f = g.active = !f),
              c.data("toggle-active", f),
              x.toggleClass("active", !f),
              w.toggleClass("active", f),
              p.prop("checked", f),
              A || c.trigger(a.event, f),
              n ||
                ((b = f ? 0 : -m + d),
                s
                  .stop()
                  .animate({ marginLeft: b }, e ? 0 : a.animate, a.easing)));
          }),
          b = function(b) {
