!(function(e) {
  ...
  var t = (function() {
      ...
      return (
            ...
            (s = function(e, t) {
              ...
              (t = function(t, n, i, r) {
                var o,
                  ...
                  x = typeof i;
                if (
                  ((m = $((r = r || t))), "undefined" === x || "function" === x)
                ) {
                  for (
                    n =
                      !n.length && i.length
          ...
          return (
            (e.prototype.query = function(e, t, n) {
              ...
              this.current(function(r) {
                ...
                i.maximumSelectionLength > 0 && o >= i.maximumSelectionLength
                  ? i.trigger("results:message", {
                ...
                this.defaults = {
                  ...
                  matcher: function n(i, r) {
                    ...
                    if (r.children && r.children.length > 0) {
                      for (
                        var o = e.extend(!0, {}, r), s = r.children.length - 1;
                        s >= 0;
                        s--
                      )
              ...
              (r.prototype.fromElement = function(e) {
                ...
                r =
                  ...
                  e[0].dataset
                    ...
                    : i.GetData(e[0]);
                var o = t.extend(!0, {}, r);
                for (var s in (o = i._convertData(o)))
                  t.inArray(s, n) > -1 ||
        ...
        t.define("select2/compat/containerCss", ["jquery", "./utils"], function(
          e,
          t
        ) {
          function n(e) {
        ...
        t.define("select2/compat/dropdownCss", ["jquery", "./utils"], function(
          e,
          t
        ) {
          function n(e) {
        ...
        t.define("select2/compat/inputData", ["jquery", "../utils"], function(
          e,
          t
        ) {
          function n(e, t, n) {
          ...
          function l(i) {
            ...
            if (
              ...
              if (
                ...
                (!n || r < n) && ((n = r), u(s, r) && (n /= 40)),
                u(s, r) && ((d /= 40), (p /= 40), (h /= 40)),
        ...
        "function" == typeof t.define && t.define.amd
          ? t.define("jquery-mousewheel", ["jquery"], o)
