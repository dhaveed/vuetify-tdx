    ...
    champ: function(options) {
      ...
      return this.each(function() {
        ...
        if (ajax == "true") {
          $.ajax({
            ...
            success: function(result) {
              $(" .tab_content.tab_" + show_ajax_content_in_tab, parent).html(
                result
              );
            }
          });
          ...
          $(document).ajaxError(function(event, request, settings) {
            $(" .tab_content.tab_" + show_ajax_content_in_tab, parent).prepend(
              "<h4 class='error'>Error requesting page " +
                settings.url +
                "</h2>"
            );
          });
        ...
        if (active_tab == "") {
          ...
          $(this)
            .find(" > div > div.tab_content:eq(0)")
            .addClass("active")
            .show(); //set active tab on load
          hide_controls(parent);
        } else {
          $(this)
            .find(" >ul li:eq(" + (active_tab - 1) + ")")
            .addClass("active")
            .show(); //set active tab on load
          $(this)
            .find(" > div > div.tab_content:eq(" + (active_tab - 1) + ")")
            .addClass("active")
            .show(); //set active tab on load
          hide_controls(parent);
        }
        ...
        if (multiple_tabs == "true") {
          ...
          var active_tab_text = $(this)
            .find(" >ul li:eq(0)")
            .text();
          get_parent.addClass("show-as-dropdown");
          get_parent.prepend(
            "<div class='active_tab'><span class='text'>" +
              active_tab_text +
        ...
        tab_selector.each(function() {
          ...
          tab_content_selector.each(function() {
            if ($(this).hasClass(add_relation)) {
              get_parent
                .find(" > div > div.tab_content." + add_relation)
                .before(
                  "<div title='" +
                    add_relation +
        ...
        $(".accordian_header").click(function() {
          ...
          if (content_status == "none") {
            get_closest_parent
              .find(">.content_wrapper >.accordian_header")
              .removeClass("active");
            $(this).addClass("active");
            get_closest_parent.find(">ul >li").removeClass("active");
            get_closest_parent
              .find(">ul >li[rel='" + clicked_header + "']")
              .addClass("active");
            ...
            tab_content_selector
              ...
              .slideUp();
            get_closest_parent
              .find(" > div > div.tab_content." + clicked_header)
              .addClass("active")
              .stop(true, true)
              .slideDown();
          } else {
        ...
        tab_selector.click(function() {
          ...
          get_closest_tab_list
            .next(".content_wrapper")
            .find(" >.accordian_header")
            .removeClass("active");

          get_new_closest_parent
            .find(".accordian_header." + clicked_tab)
            .addClass("active");

          tab_content_selector.removeClass("active").hide();
          get_new_closest_parent
            .find(" > div > div.tab_content." + clicked_tab)
            .addClass("active")
            .show();
