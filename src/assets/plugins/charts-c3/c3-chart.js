...
(function(global, factory) {
  ...
  Chart.prototype.axis.max = function(max) {
    ...
    if (arguments.length) {
      if (
        (typeof max === "undefined" ? "undefined" : _typeof(max)) === "object"
      ) {
        if (isValue(max.x)) {
  ...
  Chart.prototype.axis.min = function(min) {
    ...
    if (arguments.length) {
      if (
        (typeof min === "undefined" ? "undefined" : _typeof(min)) === "object"
      ) {
        if (isValue(min.x)) {
  ...
  Chart.prototype.load = function(args) {
    ...
    if ("unload" in args) {
      ...
      $$.unload(
        $$.mapToTargetIds(
          typeof args.unload === "boolean" && args.unload ? null : args.unload
        ),
        function() {
          $$.loadFromArgs(args);
        }
  ...
  ChartInternal.prototype.redrawArc = function(
    ...
    if (hasGaugeType) {
      ...
      if ($$.filterTargetsToShow($$.data.targets).length === 1) {
        ...
        mainArcLabelLine
          .style("fill", function(d) {
            return config.color_pattern.length > 0
  ...
  ChartInternal.prototype.getTargetSelectorSuffix = function(targetId) {
    return this.generateTargetClass(targetId).replace(
      /([?!@#$%^&*()_=+,.<>'":;\[\]\/|~`{}\\])/g,
      "\\$1"
    );
  };
  ...
  ChartInternal.prototype.getDefaultConfig = function() {
    var config = {
      ...
      tooltip_contents: function tooltip_contents(
        d,
        defaultTitleFormat,
        defaultValueFormat,
        color
  ...
  ChartInternal.prototype.hasDataLabel = function() {
    ...
    if (typeof config.data_labels === "boolean" && config.data_labels) {
      ...
      _typeof(config.data_labels) === "object" &&
  ...
  ChartInternal.prototype.getYDomain = function(targets, axisId, xDomain) {
    ...
    if (showHorizontalDataLabel) {
      ...
      padding_top += $$.axis.convertPixelsToAxisPadding(
        lengths[1],
        domainLength
      );
      padding_bottom += $$.axis.convertPixelsToAxisPadding(
        lengths[0],
        domainLength
      );
    }
  ...
  ChartInternal.prototype.getXDomainPadding = function(domain) {
    ...
    if (
      _typeof(config.axis_x_padding) === "object" &&
      ...
      .on(
        ...
        config.interaction_enabled
          ? function() {
              ...
              if (
                $$.mouseover &&
                (!closest || closest.id !== $$.mouseover.id)
              ) {
