...
!(function(a) {
  "function" == typeof define && define.amd
    ? define(["inputmask.dependencyLib", "inputmask"], a)
      ...
      numeric: {
        mask: function(a) {
          ...
          a.placeholder.length > 1 && (a.placeholder = a.placeholder.charAt(0)),
            (a.radixFocus =
              a.radixFocus && "" !== a.placeholder && a.integerOptional === !0),
          ...
          return (
            ...
            null !== a.min &&
              ((a.min = a.min
                .toString()
                .replace(new RegExp(b.escapeRegex(a.groupSeparator), "g"), "")),
              "," === a.radixPoint &&
        ...
        postFormat: function(c, d, e) {
          e.numericInput === !0 &&
            ((c = c.reverse()), isFinite(d) && (d = c.join("").length - d - 1));
          var f,
            g,
            h = !1;
        ...
        onBeforeWrite: function(c, d, e, f) {
          ...
          if (
            c &&
            ("blur" === c.type || "checkval" === c.type || "keydown" === c.type)
          ) {
            ...
            if (
              ...
              if (
                ...
                for (var o = 1; o <= f.digits; o++)
                  f.digitsOptional ||
                  (void 0 !== i[m + o] && i[m + o] !== f.placeholder.charAt(0))
                    ? -1 !== n &&
                      void 0 !== h[n + o] &&
                      (i[m + o] = i[m + o] || h[n + o])
                    : (i[m + o] = "0");
          ...
          return (
            ...
            d.unmaskAsNumber
              ? ("" !== d.radixPoint &&
                  ...
                  (e = e.replace(b.escapeRegex.call(this, d.radixPoint), ".")),
                Number(e))
              : e
          );
        },
        ...
        onKeyDown: function(c, d, e, f) {
          ...
          if (c.ctrlKey)
            switch (c.keyCode) {
              case b.keyCode.UP:
                g.val(
                  parseFloat(this.inputmask.unmaskedvalue()) + parseInt(f.step)
                ),
                  g.trigger("setvalue");
                break;
              case b.keyCode.DOWN:
