...
!(function(a) {
  ...
  function h(e, f, g) {
    ...
    function p(b, c, d, e) {
      if (
        e ||
        (g.insertMode && void 0 !== m().validPositions[b] && void 0 === d)
      ) {
        var f,
        ...
        for (f = j = b; i >= f; f++) {
          ...
          if (void 0 !== q)
            for (
              ...
              ((null == q.match.fn &&
                l[f] &&
                (l[f].match.optionalQuantifier === !0 ||
                  l[f].match.optionality === !0)) ||
                null != q.match.fn);
              ...
              if (
                ...
                (!g.keepStatic &&
                  l[f] &&
                  ((void 0 !== l[f + 1] &&
                    v(f + 1, l[f].locator.slice(), f).length > 1) ||
                    void 0 !== l[f].alternation))
                  ? r++
                  : (r = E(j)),
    ...
    function q(b, c, d, e) {
      ...
      for (m().p = b, h = c - 1; h >= i; h--)
        void 0 !== m().validPositions[h] &&
          (d === !0 ||
            (!f(h) && g.canClearPosition(m(), h, o(), e, g) !== !1)) &&
      ...
      for (n(!0), h = i + 1; h <= o(); ) {
        ...
        if (
          ...
          var p = r(h);
          k === !1 && j[i] && j[i].match.def === p.match.def
            ? ((m().validPositions[i] = a.extend(!0, {}, j[i])),
              (m().validPositions[i].input = p.input),
              delete m().validPositions[h],
              h++)
            : t(i, p.match.def)
            ? B(i, p.input || I(h), !0) !== !1 &&
              (delete m().validPositions[h], h++, (k = !0))
            : C(h) || (h++, i--),
            i++;
        }
      }
            ...
            : a.each(b, function(a, b) {
                if ("" !== b.def)
                  if (0 === c.length) c = b.locator.slice();
                    ...
                    for (var d = 0; d < c.length; d++)
                      b.locator[d] &&
                        -1 === c[d].toString().indexOf(b.locator[d]) &&
                        (c[d] += "," + b.locator[d]);
              }),
          c
        );
    ...
    function B(c, d, e, f) {
      function h(a) {
        return ja
          ? a.begin - a.end > 1 || (a.begin - a.end === 1 && g.insertMode)
          : a.end - a.begin > 1 || (a.end - a.begin === 1 && g.insertMode);
      }
      function i(b, d, e, f) {
        var i = !1;
        return (
          a.each(v(b), function(j, k) {
            for (
              var l = k.match, r = d ? 1 : 0, s = "", t = l.cardinality;
              t > r;
              t--
            )
              s += G(b - (t - 1));
            if (
              ...
              (i =
                null != l.fn
                  ? l.fn.test(s, m(), b, e, g, h(c))
                  : (d !== l.def && d !== g.skipOptionalPartCharacter) ||
                    "" === l.def
                  ? !1
                  : { c: l.placeholder || l.def, pos: b }),
              i !== !1)
            ) {
              var u = void 0 !== i.c ? i.c : d;
              u =
                u === g.skipOptionalPartCharacter && null === l.fn
                  ? l.placeholder || l.def
                  : u;
              var v = b,
                w = x();
              if (
                ...
                void 0 !== i.pos &&
                i.pos !== b &&
                ((v = i.pos), y(b, v, x().slice()), v !== b)
              )
                return (i = a.extend(i, B(v, u, !0))), !1;
              return i !== !0 && void 0 === i.pos && void 0 === i.c
                ? !1
                : (j > 0 && n(!0),
                  p(v, a.extend({}, k, { input: z(u, l) }), f, h(c)) ||
                    (i = !1),
                  !1);
            }
          }),
      ...
      for (
        var s = !1, t = a.extend(!0, {}, m().validPositions), w = l - 1;
        w > -1 && !m().validPositions[w];
        w--
      );
      var F;
      for (w++; l > w; w++)
        void 0 === m().validPositions[w] &&
          (g.jitMasking === !1 || g.jitMasking > w) &&
          ((F = r(w)).match.def === g.radixPointDefinitionSymbol ||
            !C(w, !0) ||
            (a.inArray(g.radixPoint, x()) < w &&
              F.match.fn &&
              F.match.fn.test(I(w), m(), w, !1, g))) &&
          i(
            o(w, !0) + 1,
            F.match.placeholder ||
              (null == F.match.fn ? F.match.def : "" !== I(w) ? I(w) : x()[w]),
            !0,
            f
          );
      if (
        (h(c) && (Q(void 0, b.keyCode.DELETE, c), (l = m().p)),
        l < D() && ((s = i(l, d, e, f)), (!e || f === !0) && s === !1))
      ) {
        var H = m().validPositions[l];
        if (
          !H ||
          null !== H.match.fn ||
          (H.match.def !== d && d !== g.skipOptionalPartCharacter)
        ) {
          if (
      ...
      return (
        ...
        s === !0 && (s = { pos: l }),
        a.isFunction(g.postValidation) &&
          s !== !1 &&
          !e &&
          f !== !0 &&
          (s = g.postValidation(x(!0), s, g) ? s : !1),
      ...
      a.each(j, function(b, d) {
        if (void 0 !== d) {
          ...
          if (!h() || e || g.autoUnmask) {
            var s = e
              ? b
              : null == q.match.fn && q.match.optionality && j + 1 < m().p
              ? j + 1
              : m().p;
          ...
          if (
            ...
            ((i = g.onBeforeWrite(f, x(), i.forwardPosition, g)),
          ...
          a.valHooks[b] = {
            get: function(a) {
              if (a.inputmask) {
                ...
                var b = c(a);
                return -1 !==
                  o(void 0, void 0, a.inputmask.maskset.validPositions) ||
                  g.nullable !== !0
                  ? b
                  : "";
              }
    ...
    function R(d) {
      ...
      if (
        ...
        h === b.keyCode.DELETE ||
        (l && h === b.keyCode.BACKSPACE_SAFARI) ||
        (d.ctrlKey && h === b.keyCode.X && !c("cut"))
      )
        d.preventDefault(),
          Q(e, h, i),
        ...
        if (q !== !1) {
          ...
          if ((n(!0), void 0 !== q.caret)) l = q.caret;
            ...
            l =
              !g.keepStatic &&
              ((void 0 !== s[r + 1] &&
                v(r + 1, s[r].locator.slice(), r).length > 1) ||
                void 0 !== s[r].alternation)
                ? r + 1
                : E(r);
          }
          m().p = l;
        ...
        if (e !== !1) {
          ...
          if (
            ...
            H(
              i,
              u,
              g.numericInput && void 0 === q.caret ? F(l) : l,
              c,
              d !== !0
            ),
              d !== !0 &&
    ...
    function T(b) {
      ...
      return (
        J(d, !1, !1, ja ? l.split("").reverse() : l.toString().split("")),
        H(d, x(), E(o()), b, !0),
        O(x()) === !0 && f.trigger("complete"),
        b.preventDefault()
      );
    ...
    function ba(a) {
      ea !== x().join("") && ga.trigger("change"),
        g.clearMaskOnLostFocus &&
          ...
          fa.inputmask._valueGet() === w().join("") &&
          fa.inputmask._valueSet(""),
    ...
    function da(b) {
      if (
        ...
        ("rtl" === fa.dir || g.numericInput) &&
          ((fa.dir = "ltr"),
          fa.removeAttribute("dir"),
          (fa.inputmask.isRTL = !0),
          (ja = !0)),
        oa.off(fa),
        P(fa),
        d(fa, g) &&
        ...
        var c = a.isFunction(g.onBeforeMask)
          ? g.onBeforeMask(fa.inputmask._valueGet(), g) ||
            fa.inputmask._valueGet()
          : fa.inputmask._valueGet();
        J(fa, !0, !1, c.split(""));
        var e = x().slice();
        (ea = e.join("")),
          ...
          g.clearMaskOnLostFocus &&
            ...
            (-1 === o() ? (e = []) : N(e)),
          H(fa, e),
          document.activeElement === fa && L(fa, E(o()));
      }
    }
    var ea,
      fa,
      ...
      switch (e.action) {
        ...
        case "unmaskedvalue":
          return (
            ...
            void 0 !== fa && void 0 !== fa.inputmask
              ? ((f = fa.inputmask.maskset),
                (g = fa.inputmask.opts),
                (ja = fa.inputmask.isRTL))
              : ((ia = e.value),
                g.numericInput && (ja = !0),
                (ia = (a.isFunction(g.onBeforeMask)
                  ? g.onBeforeMask(ia, g) || ia
                  : ia
                ).split("")),
        ...
        case "isValid":
          g.numericInput && (ja = !0),
            e.value
              ? ((ia = e.value.split("")),
                J(void 0, !1, !0, ja ? ia.reverse() : ia))
              : (e.value = x().join(""));
          for (
            var pa = x(), qa = M(), ra = pa.length - 1;
            ra > qa && !C(ra);
            ra--
          );
        ...
        case "remove":
          ...
          Object.getOwnPropertyDescriptor && Object.getPrototypeOf
            ? ((sa = Object.getOwnPropertyDescriptor(
              ...
              sa &&
                fa.inputmask.__valueGet &&
                Object.defineProperty(fa, "value", {
                  get: fa.inputmask.__valueGet,
                  set: fa.inputmask.__valueSet,
                  configurable: !0
                }))
            : document.__lookupGetter__ &&
              fa.__lookupGetter__("value") &&
              fa.inputmask.__valueGet &&
              (fa.__defineGetter__("value", fa.inputmask.__valueGet),
              fa.__defineSetter__("value", fa.inputmask.__valueSet)),
            (fa.inputmask = void 0);
          break;
        case "getmetadata":
          if (a.isArray(f.metadata)) {
            for (var ta, ua = o(void 0, !0), va = ua; va >= 0; va--)
              if (
                m().validPositions[va] &&
                void 0 !== m().validPositions[va].alternation
              ) {
                ta = m().validPositions[va].alternation;
                break;
              }
            return void 0 !== ta
              ? f.metadata[m().validPositions[va].locator[ta]]
              : [];
          }
          return f.metadata;
      }
        ...
        numeric: {
          mask: function(a) {
            ...
            if (
              ...
              (a.integerDigits =
                parseInt(a.integerDigits) + (0 === e ? d - 1 : d)),
          ...
          postFormat: function(c, d, e) {
            ...
            var f,
              g,
              h = !1;
            c.length >= e.suffix.length &&
              c.join("").indexOf(e.suffix) === c.length - e.suffix.length &&
              ((c.length = c.length - e.suffix.length), (h = !0)),
              (d =
                d >= c.length
                  ? c.length - 1
                  : d < e.prefix.length
            ...
            j === e.groupSeparator && (k.splice(d--, 1), (j = k[d])),
              j !== e.radixPoint &&
                j !== e.negationSymbol.front &&
                j !== e.negationSymbol.back &&
                (k[d] = "?");
            var l = k.join(""),
              m = l;
            if (
              (l.length > 0 && e.autoGroup) ||
              -1 !== l.indexOf(e.groupSeparator)
            ) {
              ...
              if (
                ((l = "" === e.radixPoint ? l : o[0]),
                l !== e.prefix + "?0" &&
                  l.length >= e.groupSize + e.prefix.length)
              )
                for (
                  var p = new RegExp(
                    "([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"
                  ...
                  (l = l.replace(p, "$1" + e.groupSeparator + "$2")),
                    (l = l.replace(
            ...
            for (
              i = m !== l, c.length = l.length, f = 0, g = l.length;
              g > f;
              f++
            )
              c[f] = l.charAt(f);
            ...
            return (
              (q =
                e.numericInput && isFinite(d) ? c.join("").length - q - 1 : q),
              e.numericInput &&
                ((c = c.reverse()),
                a.inArray(e.radixPoint, c) < q &&
                  c.join("").length - e.suffix.length !== q &&
                  (q -= 1)),
              ...
              if (
                ...
                if (
                  (null !== f.min && isFinite(f.min) && l < parseFloat(f.min)
                    ? ((k = Math.abs(f.min)), (j = f.min < 0), (h = void 0))
                    : null !== f.max &&
                      isFinite(f.max) &&
                      l > parseFloat(f.max) &&
                      ((k = Math.abs(f.max)), (j = f.max < 0), (h = void 0)),
                  (i = k
                    .toString()
                    .replace(".", f.radixPoint)
                    .split("")),
                  isFinite(f.digits))
                ) {
                ...
                if ((k.toString() !== i && k.toString() + "." !== i) || j)
                  return (
                    !j ||
                      (0 === k && "blur" === c.type) ||
                      (i.unshift(f.negationSymbol.front),
                      i.push(f.negationSymbol.back)),
                    (i = (f.prefix + i.join("")).split("")),
                    f.numericInput && (i = i.reverse()),
                    (g = f.postFormat(i, f.numericInput ? e : e - 1, f)),
                    g.buffer &&
                      (g.refreshFromBuffer = g.buffer.join("") !== d.join("")),
                    g
                  );
              }
            }
            return f.autoGroup
              ? ((g = f.postFormat(d, f.numericInput ? e : e - 1, f)),
                (g.caret = e <= f.prefix.length ? g.pos : g.pos + 1),
                g)
              : void 0;
          },
          regex: {
            ...
            if (!e)
              if (f.numericInput === !0) {
                ...
                if ("0" === i && void 0 === c.validPositions[d - 1])
                  return { pos: d, remove: h.length - f.prefix.length - 1 };
              } else {
                ...
                if (k && (-1 === j || j >= d)) {
                  var l =
                    -1 === j ? 0 : parseInt(c.buffer.slice(j + 1).join(""));
                  if (
                    0 ===
                      k[0].indexOf(
                        "" !== f.placeholder ? f.placeholder.charAt(0) : "0"
                      ) &&
                    (k.index + 1 === d || (g !== !0 && 0 === l))
                  )
                    return (
                      c.buffer.splice(k.index, 1),
                      { pos: k.index, remove: k.index }
                    );
              ...
              validator: function(c, d, e, f, g, h) {
                ...
                if (
                  ...
                  !i &&
                    ...
                    i === !0 &&
                      ((i = g.leadingZeroHandler(c, d, e, f, g, h)), i === !0)))
                ) {
                  var j = a.inArray(g.radixPoint, d.buffer);
                  i =
                    -1 !== j &&
                    (g.digitsOptional === !1 || d.validPositions[e]) &&
                    g.numericInput !== !0 &&
                    e > j &&
                    !f
                      ? {
          ...
          canClearPosition: function(a, b, c, d, e) {
            var f = a.validPositions[b].input,
              g =
                ...
                b === c ||
                f === e.groupSeparator ||
                f === e.negationSymbol.front ||
                f === e.negationSymbol.back;
            return g;
          },
          onKeyDown: function(c, d, e, f) {
            var g = a(this);
