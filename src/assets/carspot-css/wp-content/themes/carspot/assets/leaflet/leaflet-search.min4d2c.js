    ...
    (a.Control.Search = a.Control.extend({
      ...
      _createInput: function(b, c) {
        ...
        return (
          ...
          (e.role = "search"),
          (e.id = e.role + e.type + e.size),
          (d.htmlFor = e.id),
          (d.style.display = "none"),
          (d.value = b),
          a.DomEvent.disableClickPropagation(e)
            .on(e, "keyup", this._handleKeypress, this)
            .on(e, "blur", this.collapseDelayed, this)
            .on(e, "focus", this.collapseDelayedStop, this),
          e
        );
      },
      ...
      _handleAutoresize: function() {
        this._input.style.maxWidth != this._map._container.offsetWidth &&
          (this._input.style.maxWidth = a.DomUtil.getStyle(
            this._map._container,
            "width"
          )),
          this.options.autoResize &&
            this._container.offsetWidth + 45 <
