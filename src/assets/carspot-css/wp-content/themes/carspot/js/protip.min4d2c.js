            ...
            return (
              (e.prototype = {
                ...
                _run: function() {
                  ...
                  return (
                    t.el[t.cmd].apply(t.el, t.cmdArgs),
                    this._commandList.length && this._run(),
                    !0
                  );
                }
        ...
        (function(s) {
          !(function(o, n) {
            ...
            try {
              ...
              console.warn(
                "Protip: MutationObserver polyfill haven't been loaded!"
              ),
            ...
            return (
              t.extend(!0, o.prototype, {
                ...
                createItemInstance: function(t, s) {
                  ...
                  return (
                    (this._itemInstances[o] = new i(o, t, this, s)),
                ...
                getItemInstance: function(t, i) {
                  ...
                  return this._isInited(t)
                    ? this._itemInstances[s]
                    : this.createItemInstance(t, i);
                },
                ...
                _hideAll: function(e, i) {
                  t.each(
                    ...
                    t.proxy(function(t, s) {
                      s.isVisible() &&
                        this._visibleBeforeResize.push(s) &&
                        s.hide(e, i);
                    }, this)
                  );
                },
                ...
                _onAction: function(i) {
                  ...
                  i.type === e.EVENT_CLICK &&
                    o.data.trigger === e.TRIGGER_CLICK &&
                    i.preventDefault(),
                ...
                _onBodyClick: function(i) {
                  var s = t(i.target),
                    o =
                      s.closest(
                        "." + e.SELECTOR_PREFIX + e.SELECTOR_CONTAINER
                      ) || !1,
                    n = s.closest(e.DEFAULT_SELECTOR),
                    h =
                      (this._isInited(n) ? this.getItemInstance(n) : !1,
                      this._isInited(o) ? this.getItemInstance(o) : !1);
                  (!h || (h && h.data.trigger !== e.TRIGGER_CLICK)) &&
                    t.each(this._itemInstances, function(t, i) {
                      i.isVisible() &&
                        i.data.trigger === e.TRIGGER_CLICK &&
                        (!o || i.el.protip.get(0) !== o.get(0)) &&
                        (!n || i.el.source.get(0) !== n.get(0)) &&
                        i.hide();
                    });
                },
                    ...
                    function(i) {
                          ...
                          n.each(
                            function(i, s) {
                              if (((s = t(s)), !this._isInited(s))) {
                                ...
                                o.data.trigger === e.TRIGGER_STICKY &&
                                  this.getItemInstance(s).show();
                              }
                            }.bind(this)
                          );
                        }
                      for (var o = 0; o < i.removedNodes.length; o++) {
                        ...
                        h.find(this.settings.selector).each(
                          ...
                          h.hasClass(this.settings.selector.replace(".", "")) &&
                            this.getItemInstance(h).destroy();
                      }
                    }.bind(this)
                  );
                },
                _bind: function() {
                  ...
                  i
                    ...
                    .on(
                      e.EVENT_CLICK,
                      e.SELECTOR_CLOSE,
                      t.proxy(this._onCloseClick, this)
                    ),
        ...
        (function(s) {
          !(function(o, n) {
            ...
            "function" == typeof define && define.amd
              ...
              : (o.ProtipGravityTester = n(
                  o.jQuery,
                  o.ProtipConstants,
                  o.ProtipGravityParser,
            ...
            return (
              t.extend(!0, o.prototype, {
                _Construct: function(t) {
                  ...
                  for (
                    e = 0;
                    e < this._positionList.length &&
                    !this._test(this._positionList[e]);
                    e++
                  );
                  return (
                ...
                _test: function(t) {
                  ...
                  return (
                    this._item.el.protip.css(e),
                    this._setProtipDimensions(),
                    this._topOk() &&
                    this._rightOk() &&
                    this._bottomOk() &&
                    this._leftOk()
                      ? ((e.position = t.key), (this._result = e), !0)
                      : !1
                  );
                },
                _topOk: function() {
                  return (
                    this._dimensions.offset.top -
                      this._windowDimensions.scrollTop >
                    0
                  );
                },
                _rightOk: function() {
                  return (
                    this._dimensions.offset.left + this._dimensions.width <
                    this._windowDimensions.width
                  );
                },
                _bottomOk: function() {
                  return (
          ...
          !(function(o, n) {
            ...
            function o(t, e) {
              return t.replace(/\{([\w\.]*)}/g, function(t, i) {
                for (
                  var s = i.split("."), o = e[s.shift()], n = 0, h = s.length;
                  h > n;
                  n++
                )
                  o = o[s[n]];
              ...
              t.extend(!0, n.prototype, {
                _Construct: function(t, i, s, o) {
                  return (
                    ...
                    this.el.source
                      .addClass(
                        this.classInstance.settings.selector.replace(".", "")
                      )
                      .data(this._namespaced(e.PROP_INITED), !0),
                    setTimeout(
                      function() {
                ...
                actionHandler: function(t) {
                  if (this.data.trigger === e.TRIGGER_STICKY);
                    ...
                    t !== e.EVENT_CLICK ||
                    (this.data.trigger !== e.TRIGGER_CLICK &&
                      this.data.trigger !== e.TRIGGER_CLICK2)
                  ) {
                    if (
                      this.data.trigger !== e.TRIGGER_CLICK &&
                      this.data.trigger !== e.TRIGGER_CLICK2
                ...
                destroy: function() {
                  this.hide(!0),
                    ...
                    this.el.source
                      .data(this._namespaced(e.PROP_INITED), !1)
                      .data(this._namespaced(e.PROP_IDENTIFIER), !1)
                      .removeData(),
                ...
                show: function(t, o) {
                  if (this.data.title) {
                    ...
                    var n;
                    this.data.gravity
                      ? ((n = new i(this)), delete n.position)
                      : (n = new s(this)),
                      ...
                      this.data.animate &&
                        this.el.protip
                          .addClass(e.SELECTOR_ANIMATE)
                          .addClass(
                            this.data.animate ||
                              this.classInstance.settings.animate
                          ),
                      (this._isVisible = !0);
                  }
                },
                applyPosition: function(t) {
                  this.el.protip.attr(
                    "data-" + e.DEFAULT_NAMESPACE + "-" + e.PROP_POSITION,
                    t
                  );
                },
                hide: function(t, i) {
                  return (
                    ...
                    !t && this.data.delayOut
                      ...
                      : (this.el.source.removeClass(e.SELECTOR_OPEN),
                        ...
                        this.el.protip
                          .removeClass(e.SELECTOR_SHOW)
                          .removeClass(e.SELECTOR_ANIMATE)
                ...
                _checkInteractive: function() {
                  this.data.interactive &&
                    (this.data.delayOut =
                      this.data.delayOut || e.DEFAULT_DELAY_OUT);
                },
                ...
                _appendProtip: function() {
                  (this.el.protip = o(
                    this.classInstance.settings.protipTemplate,
                    {
                    ...
                    (this.el.protipArrow = this.el.protip.find(
                      "." + e.SELECTOR_PREFIX + e.SELECTOR_ARROW
                    )),
                ...
                _getClassList: function() {
                  ...
                  return (
                    ...
                    t.push(
                      e.SELECTOR_SKIN_PREFIX + i + e.SELECTOR_SIZE_PREFIX + s
                    ),
                    t.push(
                      e.SELECTOR_SKIN_PREFIX + i + e.SELECTOR_SCHEME_PREFIX + o
                    ),
                ...
                _getIconTemplate: function() {
                  return this.data.icon
                    ? o(this.classInstance.settings.iconTemplate, {
                        icon: this.data.icon
                      })
                    : "";
                },
                _detectTitle: function() {
                  if (
                    ...
                    (this.data.titleSource =
                      this.data.titleSource || this.data.title),
                      (this.data.title = t(this.data.title).html());
                  this.data.title &&
                    this.data.title.indexOf("<a ") + 1 &&
                    (this.data.interactive = !0);
                },
                _setTarget: function() {
                  ...
                  (i =
                    i === !0
                      ? this.el.source
                      : i === e.SELECTOR_BODY &&
                        this.el.source.closest(e.SELECTOR_TARGET).length
                      ? this.el.source.closest(e.SELECTOR_TARGET)
                      : t(i ? i : e.SELECTOR_BODY)),
                ...
                _bind: function() {
                  this.data.interactive &&
                    this.el.protip
                      .on(
                        e.EVENT_MOUSEENTER,
                        t.proxy(this._onProtipMouseenter, this)
                      )
                      .on(
                        e.EVENT_MOUSELEAVE,
                        t.proxy(this._onProtipMouseleave, this)
                      ),
                    this.data.observer &&
                      ((this._observerInstance = new MutationObserver(
                        function() {
            ...
            (t = t.extend(t, {
              ...
              protip: function(t) {
                return (
                  this._protipClassInstance ||
                    ((this._protipClassInstance = new e(t)),
                    (this.protip.C = s)),
                  this._protipClassInstance
                );
              }
              ...
              t.fn.extend({
                ...
                protipToggle: function() {
                  ...
                  return (
                    t._protipBuffer.add("protipToggle", this, arguments), this
                  );
                },
                ...
                protipToggleInside: function() {
                  ...
                  return (
                    t._protipBuffer.add("protipToggleInside", this, arguments),
                    this
                  );
                }
              });
              ...
              t.extend(!0, i.prototype, {
                _Construct: function(t, e, i) {
                  return (
                    ...
                    (this._protip = this._getProto(
                      this._itemInstance.el.protip
                    )),
                    (this._source = this._getProto(
                      this._itemInstance.el.source
                    )),
                    (this._target = this._getProto(
                      this._itemInstance.el.target
                    )),
                ...
                _getPosition: function() {
                  ...
                  if (
                    ((o =
                      window.pageXOffset === o
                        ? 0
                        : this._target.el.get(0) !== document.body
                        ? 0
                        : o),
                    (n =
                    ...
                    switch (this._position) {
                      case e.POSITION_TOP:
                        (this._offset.top += -1 * (s + i.height)),
                          (t.left =
                            this._source.offset.left +
                            this._source.width / 2 -
                            this._protip.width / 2 -
                            this._target.offset.left +
                            this._offset.left +
                            o),
                          (t.top =
                            this._source.offset.top -
                            this._protip.height -
                            this._target.offset.top +
                            this._offset.top +
                            n),
                          this._placement === e.PLACEMENT_INSIDE &&
                            (t.top += this._protip.height),
                          this._placement === e.PLACEMENT_BORDER &&
                            (t.top += this._protip.height / 2);
                        break;
                      ...
                      case e.POSITION_RIGHT:
                        (this._offset.left += s + i.width),
                          ...
                          (t.top =
                            this._source.offset.top +
                            this._source.height / 2 -
                            this._protip.height / 2 -
                            this._target.offset.top +
                            this._offset.top +
                            n),
                          this._placement === e.PLACEMENT_INSIDE &&
                            (t.left -= this._protip.width),
                          this._placement === e.PLACEMENT_BORDER &&
                            (t.left -= this._protip.width / 2);
                        break;
