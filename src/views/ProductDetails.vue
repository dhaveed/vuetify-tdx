                  ...
                  <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                      ...
                      <div class="desc-points">
                        ...
                        <p>
                          ...
                          charger urgent sale. with book pouch original 4g lte.
                          16 gb condition 10/10 andriod kitkat4.4.2Bank Leased 5
                          Year plan 2013 Honda Civic 1.8 Vti Oriel Prosmatec
                          Automatic ( New Shape ) Attractive Silver Color 1 year
                          installments paid Lahore Reg number Well Maintained
                          Insurance + tracker etc included Options:
                          SunroofChilled AC Power Windows Power Steering ABS
                          braking system ETC 15000 km carefully driven No SMS /
                          Email , Serious Buyers Requested To Call .Chilled AC
                          Power Windows Power Steering ABS braking system ETC
                          15000 km carefully driven No SMS / Email , Serious
                          Buyers Requested To Call .Bank Leased 5 Year plan 2013
                          Honda Civic 1.8 Vti Oriel Prosmatec Automatic ( New
                          Shape ) Attractive Silver Color 1 year installments
                          paid Lahore Reg number Well Maintained Insurance +
                    ...
                    <div id="menu1" class="tab-pane fade">
                      ...
                      <ul class="car-feature-list ">
                        ...
                        <li>
                          <i class="flaticon-navigation"></i>Cruise Control
                        </li>
                        ...
                        <li>
                          <i class="flaticon-power-button"></i>Power Locks
                        </li>
                        ...
                        <li>
                          <i class="flaticon-photo-camera-1"></i>Reversing
                          Camera
                        </li>
                      </ul>
                          ...
                          <div class="recent-ads-list">
                            <div class="recent-ads-container">
                              ...
                              <div class="recent-ads-list-content">
                                ...
                                <p>
                                  Looking to sell the car urgently. Engine is
                                  good condition. Complete service history
                                  available. Original return file is available.
                                  After Market Alloy rims. As good as a brand
                                  new car. Lady Driven Car in Immaculate
                                  Condition. No Work Required in Car. ...
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="ads-list-archive ">
                          ...
                          <div class="col-lg-8 col-md-8 col-sm-8 no-padding">
                            ...
                            <div class="ad-archive-desc">
                              ...
                              <ul class="add_info">
                                <li
                                  class="similar-ads-picture-thumbnails active"
                                >
                                  <a href="../ad/audi-a5-for-sale/index.html"
                                    ><img
                ...
                <div class="singlemap-location">
                  <div class="template-icons" style="margin-bottom: 5px;">
                    ...
                    <div class="class-name">
                      3225 West Olympic Boulevard, Los Angeles, CA, United
                      States
                    </div>
                  </div>
                </div>
