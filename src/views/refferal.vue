                    ...
                    <ul class="nav">
                        ...
                        <li> <a href="#subPages" class="collapsed" data-toggle="collapse"><i class="la la-tasks"></i> <span>My Inventory</span> <i class="icon-submenu la la-chevron-left"></i></a>
                            <div id="subPages" class="collapse ">
                                <ul class="nav">
                                    <li>
                                        <a href="../tempview/published-inventory.html"> 
                              Published 
                              <span class="badge"> 
                                  0 
                              </span> 
                        ...
                        <li><a href="../tempview/refferals.html" class="active"><i class="la la-users"></i> <span>Referrals</span><span class="badge referral">0</span> </a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-headline">
                    <div class="panel-heading">
                        <h3 class="panel-title"> My Refferals <span>( 0 )</span></h3>
                            ...
                            <table class="table dashboard-table table-fit">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <span class="ad-cats">	<span class="padding_cats"><a href="https://carspot.scriptsbundle.com/ad_category/aston-martin/">Whatsapp</a></span><span class="padding_cats"></span></span>
                                        </td>
                                        <!-- <td>0</td> -->
                                        <td>
