            ...
            <div class="sidebar-scroll" style="overflow: hidden; width: auto; height: 95%;">
                <nav>
                    <ul class="nav">
                        ...
                        <li><a href="../tempview/messaging.html" class="active"><i class="la la-envelope"></i> <span>My Messages</span></a></li>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="panel  panel-headline">
                            ...
                            <div class="panel-body panel-body-settings panel-body-settings-messaging">
                                <div class="row">
                                                            ...
                                                            <li class="message-grid">
                                                                <a href="#">
                                                                    <div class="image img-square">
                                                                        <img src="../assets/images/profile-product-details.jpg" alt="">
                                                                    </div>
                                                                    <div class="user-name">
                                                                        <div class="author">
                                                                            <span>John Doe</span>
                                            ...
                                            <div class="col-md-8 clearfix col-sm-5 col-xs-12 message-content">
                                                <div class="message-details">
                                                    ...
                                                    <div class="list-wraps ps-container ps-active-y">
                                                        <ul class="messages">
                                                            <li class="friend-message clearfix">
                                                                <figure class="profile-picture">
                                                                    <img src="../assets/images/profile-product-details.jpg" class="img-circle img-circle-messaging" alt="Profile Pic">
                                                                </figure>
                                                                <div class="message">
                                                        ...
                                                        <div class="ps-scrollbar-x-rail" style="width: 672px; display: none; left: 0px;">
                                                    ...
                                                    <div class="chat-form ">
                                                        <form role="form" class="form-inline">
                                                            ...
                                                            <button class="btn btn-theme" type="submit"> <i class="fa fa-paper-plane-o"></i> </button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
