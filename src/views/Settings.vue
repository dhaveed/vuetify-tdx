							...
							<div class="card-body">
								<div class="settings-tab">
									<ul class="tabs-menu nav">
										<li class=""><a href="#tab1" class="active" data-toggle="tab"><i class="icon icon-speedometer"></i> General</a></li>
										<li><a href="#tab2" data-toggle="tab" class=""><i class="icon icon-bubble"></i>  Chat</a></li>
											...
											<form class="form-horizontal" >
												...
												<div class="form-group ">
													<div class="row">
														...
														<div class="col-md-9">
															<select data-placeholder="Choose a Language..." class="form-control w-100 custom-select languages">
