                    ...
                    <ul class="nav">
                        ...
                        <li> <a href="#subPages" class="collapsed" data-toggle="collapse"><i class="la la-tasks"></i> <span>My Inventory</span> <i class="icon-submenu la la-chevron-left"></i></a>
                            <div id="subPages" class="collapse ">
                                <ul class="nav">
                                    <li>
                                        <a href="../tempview/published-inventory.html" class="active"> 
                              Published 
                              <span class="badge"> 
                                  0 
                              </span> 
                        ...
                        <li><a href="../tempview/orders-inventory.html"><i class="la la-check-circle-o"></i> <span> My Orders</span></a></li>
                        <li><a href="../tempview/settings-carspot.html"><i class="la la-cog"></i> <span> Settings</span></a></li>
                    ...
                    <div class="panel-heading">
                        ...
                        <form class="form form-inline form-published-search" method="get">
                            <div class="form-group">
                                <input type="text" class="form-control" name="search_title" value="" placeholder="Search Inventory">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="ad-date"> <i class="la la-calendar-o"></i> December 3, 2019</span>
                                            <span class="pending-post-msg"> <i class="fa fa-warning"></i> 
                                            Your post is under review                                    </span>
                                        </td>
                                        <td> <span class="ad-cats">	<span class="padding_cats"><a href="https://carspot.scriptsbundle.com/ad_category/aston-martin/">Aston Martin</a></span><span class="padding_cats"><a href="https://carspot.scriptsbundle.com/ad_category/db-11/">DB 11</a></span></span>
                                        </td>
                                        <td>0</td>
                                        <td>
                                            ...
                                            <li>
                                                <a class="protip delete_ad" data-pt-title=" Delete Ad" data-pt-position="top" data-pt-scheme="dark-transparent" data-pt-size="small" href="javascript:void(0);" data-adid="3741" style="color: red;"> <i class="la la-trash"></i></a>
                                            </li>
                             </ul>               
