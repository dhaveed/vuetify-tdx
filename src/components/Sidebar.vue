						...
						<div class="card">
							...
							<div class="card-body text-center item-user border-bottom">
								<div class="profile-pic">
									...
									<router-link to="/profile" class="text-dark"><h4 class="mt-3 mb-0 font-weight-semibold">Adedoyin Jackson</h4></router-link>
								</div>
							</div>
							<div class="item1-links  mb-0">
								<router-link to="/dashboard" class="active d-flex border-bottom">
									<span class="icon1 mr-3"><i class="icon icon-layers"></i></span> Dashboard
								</router-link>
								<router-link to="/profile" class="d-flex border-bottom">
									<span class="icon1 mr-3"><i class="icon icon-user"></i></span> Edit Profile
								</router-link>
								<router-link to="/ads" class=" d-flex  border-bottom">
									<span class="icon1 mr-3"><i class="icon icon-diamond"></i></span> My Ads
								</router-link>
								<router-link to="/favorite" class=" d-flex border-bottom">
									<span class="icon1 mr-3"><i class="icon icon-heart"></i></span> My Favorite
								</router-link>
								
								<router-link to="/orders" class="d-flex  border-bottom">
									<span class="icon1 mr-3"><i class="icon icon-basket"></i></span> Orders
								</router-link>
								
								<router-link to="/settings" class="d-flex border-bottom">
