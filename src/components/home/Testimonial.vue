  ...
  <section class="sptb position-relative ">
    <div class="container">
      <div class="section-title center-block text-center">
        <h1 class="text-white position-relative" style="color: #000!important;">Testimonials</h1>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-xl-8 col-md-12 d-block mx-auto">
                  <div class="testimonia">
                    ...
                    <a href="testimonial.html" class="btn btn-primary btn-lg" style="border-radius: 85px;">View all Testimonials</a>
                  </div>
                </div>
              </div>
            </div>
