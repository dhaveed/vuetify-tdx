				...
				<div class="row">
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det mb-4">
									...
									<ul class="d-flex">
										<li class="mr-5"><a href="#" class="icons"><i class="icon icon-briefcase text-muted mr-1"></i> RealEstate</a></li>
								...
								<div class="product-slider">
									<div id="carousel" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="carousel-item active"> <img src="../../assets/images/products/pictures/h1.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h2.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h3.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h4.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h5.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h1.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h2.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h3.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h5.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../../assets/images/products/pictures/h4.jpg" alt="img"> </div>
						...
						<div id="myCarousel5" class="owl-carousel owl-carousel-icons3">
							...
							<div class="item">
								<div class="card">
									...
									<div class="item-card7-overlaytext">
										<a href="col-left.html" class="text-white">Laxury Room</a>
										<h4 class=" mb-0">$854</h4>
									</div>
									<div class="card-body">
										<div class="item-card7-desc">
											<a href="col-left.html" class="text-dark"><h4 class="font-weight-semibold">Laxury Flat For Sale</h4></a>
										</div>
										<div class="item-card7-text">
											<ul class="icon-card mb-0">
												<li ><a href="#" class="icons"><i class="icon icon-location-pin text-muted mr-1"></i>  Los Angles</a></li>
							...
							<div class="item">
								<div class="card">
									<div class="item-card7-imgs">
										<a href="col-left.html"></a>
										<img src="../../assets/images/products/pictures/j1.jpg" alt="img" class="cover-image">
									</div>
									<div class="item-card7-overlaytext">
							...
							<div class="item">
								<div class="card">
									...
									<div class="item-card7-imgs">
										<a href="col-left.html"></a>
										<img src="../../assets/images/products/pictures/f4.jpg" alt="img" class="cover-image">
									</div>
									<div class="item-card7-overlaytext">
							...
							<div class="item">
								<div class="card">
									<div class="item-card7-imgs">
										<a href="col-left.html"></a>
										<img src="../../assets/images/products/pictures/pel.jpg" alt="img" class="cover-image">
									</div>
									<div class="item-card7-overlaytext">
										<a href="col-left.html" class="text-white"> 2BHk House</a>
							...
							<div class="item">
								<div class="card">
									...
									<div class="item-card7-imgs">
										<a href="col-left.html"></a>
										<img src="../../assets/images/products/pictures/h5.jpg" alt="img" class="cover-image">
									</div>
									<div class="item-card7-overlaytext">
										<a href="col-left.html" class="text-white"> Duplex House</a>
										<h4 class="mb-0">$925</h4>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card">
							...
							<div class="card-footer">
								<div class="text-left">
									<a href="#" class="btn  btn-success"><i class="fa fa-envelope"></i> Chat</a>
									...
									<ul class="vertical-scroll">
										...
										<li class="item">
											<div class="media  mb-0 p-5 mt-0">
												...
												<div class="media-body">
													<h4 class="mt-2 mb-1">Laxury House</h4>
													<span class="rated-products-ratings">
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
							...
							<div class="card-body">
								...
								<div class="form-group">
									<select name="country" id="select-countries" class="form-control custom-select select2-show-search">
										...
										<option value="9">Laxury Rooms</option>
							...
							<div class="card-body">
								<div class="product-tags clearfix">
									<ul class="list-unstyled mb-0">
										...
										<li><a href="#">Laxury Rooms</a></li>
										<li><a href="#">Apartments</a></li>
										<li><a href="#">3BHK Flatss</a></li>
										<li><a href="#">Homes</a></li>
										<li><a href="#">Laxury House For Sale</a></li>
										<li><a href="#">Apartments</a></li>
										<li><a href="#" class="mb-0">Laxury Rooms</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body pb-3">
								<ul class="vertical-scroll">
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/1.png" alt="img" class="w-8 border"/></td>
												<td class="pl-4"><h5 class="mb-1 ">Best New Model Houses</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/2.png" alt="img" class="w-8 border"/></td>
												<td class="pl-4"><h5 class="mb-1 ">Trending New Model Houses</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/3.png" alt="img" class="w-8 border" /></td>
												<td class="pl-4"><h5 class="mb-1 ">Best New Model Houses</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/4.png" alt="img" class="w-8 border" /></td>
												<td class="pl-4"><h5 class="mb-1 ">Trending New Model Houses</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/5.png" alt="img" class="w-8 border" /></td>
												<td class="pl-4"><h5 class="mb-1 ">Best New Model Houses</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/6.png" alt="img" class="w-8 border" /></td>
												<td class="pl-4"><h5 class="mb-1 ">Duplex House</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
										<table>
											<tr>
												<td><img src="../../assets/images/products/7.png" alt="img" class="w-8 border" /></td>
												<td class="pl-4"><h5 class="mb-1 ">Modren Flats</h5><a href="#" class="btn-link">View Details</a><span class="float-right font-weight-bold">$17</span></td>
											</tr>
										</table>
									</li>
								</ul>
