        ...
        <div class="col-xl-8 col-lg-8 col-md-12">
            ...
            <div class="card-body">
              <div class="item-det mb-4">
                <a href="#" class="text-dark"
                  ><h3 class="">
                    Affordable 2 BHK Flats Available in Gated Community
                  </h3></a
                >
                <ul class="d-flex">
                  <li class="mr-5">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="mb-4">
                <p>
                  Laxury Home For Sale odio dignissimos ducimus qui blanditiis
              ...
              <div class="row">
                ...
                <div class="col-xl-6 col-md-12">
                  <ul class="list-unstyled widget-spec mb-0">
                    ...
                    <li class="">
                      <i class="fa fa-futbol-o text-muted w-5"></i> football
                      Court
                    </li>
                    <li class="mb-0">
            ...
            <div class="card-footer">
              <div class="icons">
                ...
                <a href="#" class="btn btn-primary icons"
                  ><i class="icon icon-heart  mr-1"></i> 678</a
                >
                <a href="#" class="btn btn-secondary icons"
          ...
          <div id="myCarousel5" class="owl-carousel owl-carousel-icons3">
                ...
                <div class="card-body">
                  <div class="item-card7-desc">
                    <a href="col-left.html" class="text-dark"
                      ><h4 class="font-weight-semibold">House For Sale</h4></a
                    >
                  </div>
                  <div class="item-card7-text">
                    <ul class="icon-card mb-0">
                      <li>
                        <a href="#" class="icons"
                          ><i
                            class="icon icon-location-pin text-muted mr-1"
                          ></i>
                          Los Angles</a
                        >
                      </li>
                      <li>
                        <a href="#" class="icons"
                          ><i class="icon icon-event text-muted mr-1"></i> 5
                          hours ago</a
                        >
                      </li>
                      <li class="mb-0">
                        <a href="#" class="icons"
                          ><i class="icon icon-user text-muted mr-1"></i> Sally
                          Peake</a
                        >
                      </li>
                      <li class="mb-0">
            ...
            <div class="item">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="item-card7-desc">
                    <a href="col-left.html" class="text-dark"
                      ><h4 class="font-weight-semibold">Home For Sale</h4></a
                    >
                  </div>
                  <div class="item-card7-text">
                    <ul class="icon-card mb-0">
            ...
            <div class="item">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="item-card7-desc">
                    <a href="rcol-left.html" class="text-dark"
                      ><h4 class="font-weight-semibold">
                        2BHK Flat For Rent
                      </h4></a
                    >
            ...
            <div class="item">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="item-card7-desc">
                    <a href="col-left.html" class="text-dark"
                      ><h4 class="font-weight-semibold">Flat For Rent</h4></a
                    >
                  </div>
                  <div class="item-card7-text">
                    <ul class="icon-card mb-0">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="mb-4">
                    <p class="mb-2">
                      <span class="fs-14 ml-2"
                        ><i class="fa fa-star text-yellow mr-2"></i>5</span
                      >
                    </p>
                  ...
                  <div class="mb-4">
                    <p class="mb-2">
                      <span class="fs-14 ml-2"
                        ><i class="fa fa-star text-yellow mr-2"></i>4</span
                      >
                    </p>
                    <div class="progress progress-md mb-4 h-4">
                  ...
                  <div class="mb-4">
                    <p class="mb-2">
                      <span class="fs-14 ml-2"
                        ><i class="fa fa-star text-yellow mr-2"></i> 3</span
                      >
                    </p>
                    <div class="progress progress-md mb-4 h-4">
                  ...
                  <div class="mb-4">
                    <p class="mb-2">
                      <span class="fs-14 ml-2"
                        ><i class="fa fa-star text-yellow mr-2"></i> 2</span
                      >
                    </p>
                    <div class="progress progress-md mb-4 h-4">
                  ...
                  <div class="mb-5">
                    <p class="mb-2">
                      <span class="fs-14 ml-2"
                        ><i class="fa fa-star text-yellow mr-2"></i> 1</span
                      >
                    </p>
                    <div class="progress progress-md mb-4 h-4">
              ...
              <div class="media mt-0 p-5">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1 font-weight-semibold">
                    ...
                    ></span>
                    <span class="fs-14 ml-2">
                      4.5 <i class="fa fa-star text-yellow"></i
                    ></span>
                  </h5>
                  <small class="text-muted"
                    ><i class="fa fa-calendar"></i> Dec 21st
                    <i class=" ml-3 fa fa-clock-o"></i> 13.00
                    <i class=" ml-3 fa fa-map-marker"></i> Brezil</small
                  >
                  <p class="font-13  mb-2 mt-2">
                    Ut enim ad minim veniam, quis Neque porro quisquam est, qui
                    dolorem ipsum quia dolor sit amet, consectetur, adipisci
                    velit, sed quia non numquam eius modi tempora incidunt ut
                    labore et nostrud exercitation ullamco laboris commodo
                    consequat.
                  </p>
                  <a href="#" class="mr-2 btn btn-primary btn-sm"
                    ><span class="">Helpful</span></a
                  >
                  <a
                    href=""
                  ...
                  <div class="media mt-5">
                    ...
                    <div class="media-body">
                      ...
                      <small class="text-muted"
                        ><i class="fa fa-calendar"></i> Dec 22st
                        <i class=" ml-3 fa fa-clock-o"></i> 6.00
                        <i class=" ml-3 fa fa-map-marker"></i> Brezil</small
                      >
                      <p class="font-13  mb-2 mt-2">
                        Ut enim ad minim veniam, quis nostrud exercitation
                        ullamco laboris commodo At vero eos et accusamus et
                        iusto odio dignissimos ducimus qui blanditiis
                        praesentium, nisi ut aliquid ex ea commodi consequatur
                        consequat.
                      </p>
                      <a
                        href=""
              ...
              <div class="media p-5 border-top mt-0">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1 font-weight-semibold">
                    ...
                    ></span>
                    <span class="fs-14 ml-2">
                      4 <i class="fa fa-star text-yellow"></i
                    ></span>
                  </h5>
                  <small class="text-muted"
                    ><i class="fa fa-calendar"></i> Dec 21st
                    <i class=" ml-3 fa fa-clock-o"></i> 16.35
                    <i class=" ml-3 fa fa-map-marker"></i> UK</small
                  >
                  <p class="font-13  mb-2 mt-2">
                    Ut enim ad minim veniam, quis Neque porro quisquam est, qui
                    dolorem ipsum quia dolor sit amet, consectetur, adipisci
            ...
            <div class="card-body  item-user">
              <div class="profile-pic mb-0">
                ...
                <div class="">
                  ...
                  <h6 class="mt-2 mb-0">
                    <a href="userprofile2.html" class="btn btn-primary btn-sm"
                      >See All Ads</a
                    >
                  </h6>
                </div>
              ...
              <div>
                <h6>
                  ...
                  ><a href="#" class="text-body">
                    7981 Aspen Ave. Hammonton, USA</a
                  >
                </h6>
                <h6>
                  <span class="font-weight-semibold"
                ...
                <h6>
                  ...
                  ><a href="#" class="text-body"> 0-235-657-24587</a>
                </h6>
                <h6>
                  <span class="font-weight-semibold"
                ...
                <li class="news-item">
                  <table>
                    <tr>
                      ...
                      <td class="pl-4">
                        <h5 class="mb-1 ">Best New Model Houses</h5>
                        <a href="#" class="btn-link">View Details</a
                        ><span class="float-right font-weight-bold">$17</span>
                      </td>
                    </tr>
                  </table>
                </li>
                <li class="news-item">
                  <table>
                    <tr>
                      ...
                      <td class="pl-4">
                        <h5 class="mb-1 ">Trending New Model Houses</h5>
                        <a href="#" class="btn-link">View Details</a
                        ><span class="float-right font-weight-bold">$17</span>
                      </td>
                    </tr>
