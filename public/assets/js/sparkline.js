$(function(e) {
  ...
  $(".sparkline11").sparkline(
    [3, 4, 3, 4, 5, 4, 5, 4, 3, 4, 6, 2, 4, 3, 4, 5, 4, 5, 4, 3],
    {
      type: "bar",
      height: "43",
      barWidth: 12,
...
if ($("#chart_gauge_03").length) {
  ...
  var chart_gauge_03 = new Gauge(chart_gauge_03_elem).setOptions(
    chart_gauge_settings
  );
}
