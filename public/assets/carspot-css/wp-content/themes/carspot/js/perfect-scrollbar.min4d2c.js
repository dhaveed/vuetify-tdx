...
(function(e) {
  ...
  e.fn.perfectScrollbar = function(n, l) {
    return this.each(function() {
      ...
      function c(e) {
        return (
          L.minScrollbarLength && (e = Math.max(e, L.minScrollbarLength)),
      ...
      function s() {
        ...
        F
          ? (t.right = I
              ? D - S.scrollLeft() - z - Q.outerWidth()
              : z - S.scrollLeft())
          : (t.left = I
              ? S.scrollLeft() + 2 * P - D - G - Q.outerWidth()
              : G + S.scrollLeft()),
          U.css(t),
          O.css({ left: X, width: E - H }),
      ...
      function d() {
        S.removeClass("ps-active-x"),
          ...
          !L.suppressScrollX && D > P + L.scrollXMarginOffset
            ? ((M = !0),
              (E = c(t((P * P) / D))),
              (X = t((S.scrollLeft() * (P - E)) / (D - P))))
            : ((M = !1), (E = 0), (X = 0), S.scrollLeft(0)),
          !L.suppressScrollY && C > x + L.scrollYMarginOffset
            ? ((Y = !0),
              (k = c(t((x * x) / C))),
              (W = t((S.scrollTop() * (x - k)) / (C - x))))
            : ((Y = !1), (k = 0), (W = 0), S.scrollTop(0)),
          X >= P - E && (X = P - E),
          W >= x - k && (W = x - k),
          s(),
      ...
      function u() {
        ...
        O.bind(j("mousedown"), function(e) {
          ...
          e(A).bind(j("mousemove"), function(e) {
            n &&
              (a(t, e.pageX - o), d(), e.stopPropagation(), e.preventDefault());
          }),
      ...
      function p() {
        ...
        Q.bind(j("mousedown"), function(e) {
          ...
          e(A).bind(j("mousemove"), function(e) {
            n &&
              (i(t, e.pageY - o), d(), e.stopPropagation(), e.preventDefault());
          }),
          e(A).bind(j("mouseup"), function() {
      ...
      function f(e, t) {
        ...
        if (0 === e) {
          if (!Y) return !1;
          if ((0 === o && t > 0) || (o >= C - x && 0 > t))
            return !L.wheelPropagation;
        }
        var n = S.scrollLeft();
        if (0 === t) {
          if (!M) return !1;
          if ((0 === n && 0 > e) || (n >= D - P && e > 0))
            return !L.wheelPropagation;
        }
        return !0;
      }
      function v() {
        ...
        function t(t) {
          ...
          (o = !1),
            L.useBothWheelAxes
              ? Y && !M
                ? (l
                    ? S.scrollTop(S.scrollTop() - l * L.wheelSpeed)
                    : S.scrollTop(S.scrollTop() + r * L.wheelSpeed),
                  (o = !0))
                : M &&
                  !Y &&
                  (r
                    ? S.scrollLeft(S.scrollLeft() + r * L.wheelSpeed)
                    : S.scrollLeft(S.scrollLeft() - l * L.wheelSpeed),
                  (o = !0))
              : (S.scrollTop(S.scrollTop() - l * L.wheelSpeed),
                S.scrollLeft(S.scrollLeft() + r * L.wheelSpeed)),
            d(),
        ...
        window.onwheel !== void 0
          ? S.bind(j("wheel"), t)
          : window.onmousewheel !== void 0 && S.bind(j("mousewheel"), t);
      }
      function g() {
        var t = !1;
        ...
        e(A).bind(j("selectionchange"), function() {
          ...
          e(window).bind(j("mousemove"), function(e) {
            if (i) {
              ...
              t.x < a.left + 3
                ? ((l.left = -5), K.addClass("in-scrolling"))
                : t.x > a.right - 3
                ? ((l.left = 5), K.addClass("in-scrolling"))
                : (l.left = 0),
                t.y < a.top + 3
      ...
      function w(t, o) {
        ...
        function u() {
          !b &&
            ...
            (g = setInterval(function() {
              return 0.01 > Math.abs(v.x) && 0.01 > Math.abs(v.y)
                ? (clearInterval(g), void 0)
        ...
        var p = {},
          ...
          h = !1;
        t &&
          (e(window).bind(j("touchstart"), r),
          e(window).bind(j("touchend"), l),
          S.bind(j("touchstart"), c),
          S.bind(j("touchmove"), s),
          S.bind(j("touchend"), u)),
          o &&
            (window.PointerEvent
              ? (e(window).bind(j("pointerdown"), r),
                e(window).bind(j("pointerup"), l),
                S.bind(j("pointerdown"), c),
                S.bind(j("pointermove"), s),
                S.bind(j("pointerup"), u))
              : window.MSPointerEvent &&
                (e(window).bind(j("MSPointerDown"), r),
                e(window).bind(j("MSPointerUp"), l),
                S.bind(j("MSPointerDown"), c),
                S.bind(j("MSPointerMove"), s),
                S.bind(j("MSPointerUp"), u)));
      }
      function m() {
      ...
      var L = e.extend(!0, {}, o),
        S = e(this);
      if (("object" == typeof n ? e.extend(!0, L, n) : (l = n), "update" === l))
        return (
      ...
      if ("destroy" === l)
        return (
          S.data("perfect-scrollbar-destroy") &&
            S.data("perfect-scrollbar-destroy")(),
          S
        );
