...
!(function() {
  ...
  function g(b, c, d, g, h, i, j, k, l, m, n, o) {
    ...
    return (
      i && (o = i(o)),
      e(o)
        ? (b !== !1 && 0 === parseFloat(o.toFixed(b)) && (o = 0),
          0 > o && ((p = !0), (o = Math.abs(o))),
          b !== !1 && (o = f(o, b)),
          (o = o.toString()),
          -1 !== o.indexOf(".")
            ? ((q = o.split(".")), (r = q[0]), d && (t = d + q[1]))
            : (r = o),
    ...
    return (
      ...
      o && "string" == typeof o
        ? (k && b(o, k) && ((o = o.replace(k, "")), (p = !0)),
          ...
          (q += o),
          (q = q.replace(/[^0-9\.\-.]/g, "")),
          "" === q ? !1 : ((q = Number(q)), j && (q = j(q)), e(q) ? q : !1))
        : !1
    );
  }
  function i(a) {
  ...
  (function(a) {
    ...
    function c(b, c) {
      return "string" == typeof b && 0 === b.indexOf("-inline-")
        ? ((this.method = c || "html"),
          (this.target = this.el = a(b.replace("-inline-", "") || "<div/>")),
          !0)
        : void 0;
    }
    function d(b) {
      if ("string" == typeof b && 0 !== b.indexOf("-")) {
        ...
        return (
          (c.name = b), (c.type = "hidden"), (this.target = this.el = a(c)), !0
        );
      }
    }
    function e(a) {
      return "function" == typeof a
        ? ((this.target = !1), (this.method = a), !0)
        : void 0;
    }
    function f(a, c) {
      return b(a) && !c
    ...
    function g(a, c) {
      return b(a) && ("function" == typeof c || ("string" == typeof c && a[c]))
        ? ((this.method = c), (this.target = a), !0)
        : void 0;
    }
    function h(b, c, d) {
      var e = this,
      ...
      if (
        ((this.changeHandler = function(b) {
          ...
          return c === !1 || isNaN(c)
            ? (a(this).val(e.lastSetValue), !1)
            : void e.changeHandlerMethod.call("", b, c);
        }),
        (this.el = !1),
  ...
  (function(a) {
    ...
    function s(a, b, c) {
      return b
        ? void (c.xSteps[a] =
            k([c.xVal[a], c.xVal[a + 1]], b) / j(c.xPct[a], c.xPct[a + 1]))
        : !0;
    }
    function t(a, b, c, d) {
      (this.xPct = []),
    ...
    function G(b) {
      var c,
        d = { margin: 0, limit: 0, animate: !0, format: Z };
      return (
        (c = {
          step: { r: !1, t: u },
          start: { r: !0, t: w },
    ...
    function J(b, c) {
      var d = a("<div><div/></div>").addClass(Y[2]),
        e = ["-lower", "-upper"];
      return (
        b && e.reverse(), d.children().addClass(Y[3] + " " + Y[3] + e[c]), d
      );
    }
    function K(a, b, c) {
      switch (a) {
    ...
    function M(b, c, d) {
      return (
        d.addClass([Y[0], Y[8 + b], Y[4 + c]].join(" ")),
        a("<div/>")
          .appendTo(d)
          .addClass(Y[1])
      );
    ...
    function N(b, c, d) {
      ...
      function m(b) {
        ...
        E[0].linkAPI &&
          E[0].linkAPI[b] &&
          E[0].linkAPI[b].change(J[c], D[c].children(), E);
      }
      function n(b, d) {
        var e = a.inArray(b, N);
        return (
        ...
        return (
          ...
          b.on(a, function(a) {
            return E.attr("disabled")
              ...
              : E.hasClass(Y[14])
              ? !1
              : ((a = I(a)), (a.calcPoint = a.points[c.ort]), void d(a, e));
          })
        );
      }
      function q(a, b) {
        var c,
          ...
          h = d[0][0] !== D[0][0] ? 1 : 0;
        (c = H(g, b.positions, d.length > 1)),
          (f = v(d[0], c[h], 1 === d.length)),
          d.length > 1 && (f = v(d[1], c[h ? 0 : 1], !1) || f),
          f && j(["slide"]);
      }
      function r(b) {
        a("." + Y[15]).removeClass(Y[15]),
          b.cursor &&
            a("body")
              .css("cursor", "")
              .off(W),
      ...
      function s(b, c) {
        1 === c.handles.length && c.handles[0].children().addClass(Y[15]),
          b.stopPropagation(),
          p(X.move, U, q, {
            start: b.calcPoint,
            handles: c.handles,
          ...
          b.cursor &&
            ...
            D.length > 1 && E.addClass(Y[12]),
            a("body").on("selectstart" + W, !1));
      }
      function t(b) {
        var d,
          g = b.calcPoint,
        ...
        b.stopPropagation(),
          ...
          (h = h / 2 > g || 1 === D.length ? 0 : 1),
          (g -= C.offset()[c.style]),
          (d = (100 * g) / e()),
          c.events.snap || f(E, Y[14], 300),
          v(D[h], d),
          j(["slide", "set", "change"]),
          c.events.snap && s(b, { handles: [D[h]] });
      }
      function u(a) {
        var b, c;
        if (!a.fixed)
        ...
        a.tap && p(X.start, C, t, { handles: D }),
          a.drag &&
            ((c = C.find("." + Y[7]).addClass(Y[10])),
            a.fixed &&
              (c = c.add(
                C.children()
                  .not(c)
      ...
      function v(a, b, d) {
        var e = a[0] !== D[0][0] ? 1 : 0,
          ...
          j = F[1] - c.limit;
        return (
          D.length > 1 && (b = e ? Math.max(b, f) : Math.min(b, h)),
          d !== !1 &&
            c.limit &&
            D.length > 1 &&
          ...
          b === F[e]
            ? !1
            : (a.css(c.style, b + "%"),
              a.is(":first-child") && a.toggleClass(Y[17], b > 50),
              (F[e] = b),
              (J[e] = G.fromStepping(b)),
              m(N[e]),
              !0)
        );
      }
        ...
        for (c.limit && (a += 1), d = 0; a > d; d += 1)
          (e = d % 2),
            ...
            null !== f &&
              ...
              (f === !1 ||
                isNaN(f) ||
                v(D[e], G.toStepping(f), d === 3 - c.dir) === !1) &&
                m(N[e]));
      }
      function x(a) {
    ...
    function T(b, c, d, e, f, g) {
      ...
      function j(a, b) {
        d && (a = 100 - a),
          (b[1] = b[1] && f ? f(b[0], b[1]) : b[1]),
          l.append("<div " + i(a, "noUi-marker", b) + "></div>"),
          b[1] &&
            l.append(
              "<div " + i(a, "noUi-value", b) + ">" + g.to(b[0]) + "</div>"
            );
      }
    ...
    (t.prototype.getMargin = function(a) {
      ...
      (t.prototype.toStepping = function(a) {
        return (
          (a = o(this.xVal, this.xPct, a)), this.direction && (a = 100 - a), a
        );
      }),
      ...
      (t.prototype.getStep = function(a) {
        return (
          ...
          (a = q(this.xPct, this.xSteps, this.snap, a)),
          this.direction && (a = 100 - a),
          a
        );
      }),
