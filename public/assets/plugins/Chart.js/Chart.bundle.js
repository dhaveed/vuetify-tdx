        ...
        module.exports = function(Chart) {
            ...
            updateElement: function updateElement(rectangle, index, reset) {
              ...
              helpers.extend(rectangle, {
                ...
                _model: {
                  ...
                  base: reset
                    ? scaleBase
                    : this.calculateBarBase(this.index, index),
          ...
          Chart.controllers.horizontalBar = Chart.controllers.bar.extend({
            ...
            getRuler: function(index) {
              ...
              var categorySpacing =
                (tickHeight - tickHeight * yScale.options.categoryPercentage) /
                2;
          ...
          Chart.controllers.bubble = Chart.DatasetController.extend({
            ...
            updateElement: function(point, index, reset) {
              ...
              helpers.extend(point, {
                ...
                _model: {
                  ...
                  y: reset
                    ? yScale.getBasePixel()
                    : yScale.getPixelForValue(data, index, this.index),
                  // Appearance
                  radius: reset
                    ? 0
                    : custom.radius
            ...
            setHoverStyle: function(point) {
              ...
              model.radius = custom.hoverRadius
                ...
                : helpers.getValueAtIndexOrDefault(
                  ...
                  ) + this.getRadius(this.getDataset().data[point._index]);
              model.backgroundColor = custom.hoverBackgroundColor
                ? custom.hoverBackgroundColor
                : helpers.getValueAtIndexOrDefault(
                    dataset.hoverBackgroundColor,
            ...
            removeHoverStyle: function(point) {
              ...
              model.radius = custom.radius
                ? custom.radius
                : this.getRadius(dataset.data[point._index]);
              model.backgroundColor = custom.backgroundColor
                ? custom.backgroundColor
                : helpers.getValueAtIndexOrDefault(
                    dataset.backgroundColor,
          ...
          Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend(
            {
              ...
              update: function update(reset) {
                ...
                _this.outerRadius =
                  chart.outerRadius -
                  chart.radiusLength * _this.getRingIndex(_this.index);
            ...
            updateBezierControlPoints: function() {
              ...
              for (i = 0, ilen = points.length; i < ilen; ++i) {
                ...
                model.controlPointPreviousX = Math.max(
                  Math.min(controlPoints.previous.x, area.right),
                  area.left
                );
                model.controlPointPreviousY = Math.max(
                  Math.min(controlPoints.previous.y, area.bottom),
                  area.top
                );
                model.controlPointNextX = Math.max(
                  Math.min(controlPoints.next.x, area.right),
                  area.left
                );
                model.controlPointNextY = Math.max(
                  Math.min(controlPoints.next.y, area.bottom),
                  area.top
                );
        ...
        module.exports = function(Chart) {
          ...
          Chart.controllers.polarArea = Chart.DatasetController.extend({
            ...
            update: function update(reset) {
              ...
              _this.outerRadius =
                chart.outerRadius - chart.radiusLength * _this.index;
              _this.innerRadius = _this.outerRadius - chart.radiusLength;
            ...
            updateElement: function(arc, index, reset) {
              ...
              var circumference = _this.calculateCircumference(
                dataset.data[index]
              );
              ...
              var resetModel = {
                ...
                y: centerY,
                innerRadius: 0,
                outerRadius: animationOpts.animateScale
                  ? 0
                  : scale.getDistanceFromCenterForValue(dataset.data[index]),
                startAngle: animationOpts.animateRotate
                  ? Math.PI * -0.5
                  : startAngle,
                endAngle: animationOpts.animateRotate
                  ? Math.PI * -0.5
                  : endAngle,
          ...
          helpers.extend(Chart.Controller.prototype, {
            ...
            resize: function resize(silent) {
              ...
              var newHeight =
                ...
                isNaN(this.chart.aspectRatio) === false &&
            ...
            draw: function(ease) {
              ...
              Chart.pluginService.notifyPlugins("beforeDraw", [
                this,
                easingDecimal
              ]);
              ...
              Chart.pluginService.notifyPlugins("afterDraw", [
                this,
                easingDecimal
              ]);
            },
          ...
          helpers.extend(Chart.DatasetController.prototype, {
            ...
            linkScales: function() {
              ...
              if (meta.xAxisID === null) {
                meta.xAxisID =
                  dataset.xAxisID || this.chart.options.scales.xAxes[0].id;
              }
              if (meta.yAxisID === null) {
                meta.yAxisID =
                  dataset.yAxisID || this.chart.options.scales.yAxes[0].id;
              }
            },
              ...
              helpers.each(
                ...
                function(value, key) {
                  ...
                  // Color transitions if possible
                    ...
                    try {
                      var color = helpers
                        .color(this._model[key])
                        .mix(helpers.color(this._start[key]), ease);
                  ...
                  // Number transitions
                    ...
                    var startVal =
                      this._start[key] !== undefined &&
                      isNaN(this._start[key]) === false
                        ? this._start[key]
                        : 0;
                    this._view[key] =
                      (this._model[key] - startVal) * ease + startVal;
                  }
                  // Everything else
                  else {
                    this._view[key] = value;
          ...
          helpers.findIndex = function(arrayToSearch, callback, thisArg) {
            ...
            if (Array.prototype.findIndex) {
              ...
              for (var i = 0; i < arrayToSearch.length; ++i) {
                ...
                if (
                  callback.call(thisArg, arrayToSearch[i], i, arrayToSearch)
                ) {
                  index = i;
                  break;
                }
        ...
        module.exports = function() {
          ...
          var Chart = function(context, config) {
            ...
            this.width =
              ...
              parseInt(Chart.helpers.getStyle(context.canvas, "width")) ||
              Chart.helpers.getMaximumWidth(context.canvas);
            this.height =
              context.canvas.height ||
              parseInt(Chart.helpers.getStyle(context.canvas, "height")) ||
              Chart.helpers.getMaximumHeight(context.canvas);

            this.aspectRatio = this.width / this.height;

            if (
              isNaN(this.aspectRatio) ||
              isFinite(this.aspectRatio) === false
            ) {
            ...
            var _this = this;
            Chart.helpers.addResizeListener(
              context.canvas.parentNode,
              function() {
                if (
                  _this.controller &&
                  _this.controller.config.options.responsive
                ) {
        ...
        module.exports = function(Chart) {
          ...
          Chart.layoutService = {
            ...
            update: function(chartInstance, width, height) {
              ...
              var rightBoxes = helpers.where(chartInstance.boxes, function(
                box
              ) {
            ...
            fit: function() {
              ...
              if (display) {
                if (isHorizontal) {
                  ...
                  var totalHeight = this.legendItems.length
        ...
        module.exports = function(Chart) {
          ...
          Chart.defaults.scale = {
            ...
            gridLines: {
              ...
              tickMarkLength: 10,
              zeroLineWidth: 1,
              zeroLineColor: "rgba(227, 237, 252,0.25)",
          ...
          Chart.Scale = Chart.Element.extend({
            ...
            convertTicksToLabels: function() {
              ...
              this.ticks = this.ticks.map(function(
                numericalTick,
                index,
                ticks
              ) {
            ...
            fit: function() {
              ...
              if (tickOpts.display && display) {
                ...
                if (isHorizontal) {
                  ...
                  var firstLabelWidth = this.ctx.measureText(this.ticks[0])
                    .width;
      ...
      function(require, module, exports) {
        ...
        module.exports = function(Chart) {
          ...
          Chart.defaults.global.tooltips = {
            ...
            custom: null,
            mode: "single",
            backgroundColor: "rgba(56, 74, 99,0.8)",
            titleFontStyle: "bold",
            titleSpacing: 2,
            titleMarginBottom: 6,
            titleColor: "#fff",
          ...
          Chart.Tooltip = Chart.Element.extend({
            initialize: function() {
              ...
              helpers.extend(this, {
                _model: {
                  ...
                  _bodyFontFamily: helpers.getValueOrDefault(
                    tooltips.bodyFontFamily,
                    globalDefaults.defaultFontFamily
                  ),
                  _bodyFontStyle: helpers.getValueOrDefault(
                    tooltips.bodyFontStyle,
                    globalDefaults.defaultFontStyle
                  ),
                  _bodyAlign: tooltips.bodyAlign,
                  bodyFontSize: helpers.getValueOrDefault(
                  ...
                  _titleFontFamily: helpers.getValueOrDefault(
                    tooltips.titleFontFamily,
                    globalDefaults.defaultFontFamily
                  ),
                  _titleFontStyle: helpers.getValueOrDefault(
                    tooltips.titleFontStyle,
                    globalDefaults.defaultFontStyle
                  ),
                  titleFontSize: helpers.getValueOrDefault(
                  ...
                  _footerFontFamily: helpers.getValueOrDefault(
                    tooltips.footerFontFamily,
                    globalDefaults.defaultFontFamily
                  ),
                  _footerFontStyle: helpers.getValueOrDefault(
                    tooltips.footerFontStyle,
                    globalDefaults.defaultFontStyle
                  ),
                  footerFontSize: helpers.getValueOrDefault(
            ...
            // Args are: (tooltipItem, data)
            getTitle: function() {
              var beforeTitle = this._options.tooltips.callbacks.beforeTitle.apply(
                  this,
                  arguments
                ),
                title = this._options.tooltips.callbacks.title.apply(
                  this,
                  arguments
                ),
                afterTitle = this._options.tooltips.callbacks.afterTitle.apply(
                  this,
                  arguments
                );
            ...
            getBeforeBody: function() {
              var lines = this._options.tooltips.callbacks.beforeBody.apply(
                this,
                arguments
              );
            ...
            getAfterBody: function() {
              var lines = this._options.tooltips.callbacks.afterBody.apply(
                this,
                arguments
              );
              return helpers.isArray(lines)
            ...
            // Args are: (tooltipItem, data)
            getFooter: function() {
              var beforeFooter = this._options.tooltips.callbacks.beforeFooter.apply(
                this,
                arguments
              );
              var footer = this._options.tooltips.callbacks.footer.apply(
                this,
                arguments
              );
              var afterFooter = this._options.tooltips.callbacks.afterFooter.apply(
                this,
                arguments
              );
            ...
            update: function(changed) {
              if (this._active.length) {
                ...
                if (this._options.tooltips.mode === "single") {
                  ...
                  tooltipItems.push({
                    xLabel: element._xScale
                      ? element._xScale.getLabelForIndex(
                          element._index,
                          element._datasetIndex
                        )
                      : "",
                    yLabel: yScale
                      ? yScale.getLabelForIndex(
                          element._index,
                          element._datasetIndex
                        )
                      : "",
                  ...
                  helpers.each(
                    ...
                    function(dataset, datasetIndex) {
                      ...
                      var meta = this._chartInstance.getDatasetMeta(
                        datasetIndex
                      );
                      ...
                      if (currentElement) {
                        ...
                        tooltipItems.push({
                          xLabel: currentElement._xScale
                            ? currentElement._xScale.getLabelForIndex(
                                currentElement._index,
                                currentElement._datasetIndex
                              )
                            : "",
                          yLabel: yScale
                            ? yScale.getLabelForIndex(
                ...
                helpers.extend(
                  this._model,
                  this.getBackgroundPoint(this._model, tooltipSize)
                );
              } else {
            ...
            getTooltipSize: function getTooltipSize(vm) {
              ...
              var combinedBodyLength =
                vm.body.length + vm.beforeBody.length + vm.afterBody.length;
              ...
              size.height += vm.footer.length
                ? (vm.footer.length - 1) * vm.footerSpacing
                ...
                function(line) {
                  size.width = Math.max(
                    ...
                    ctx.measureText(line).width +
                      (this._options.tooltips.mode !== "single"
                        ? vm.bodyFontSize + 2
                        : 0)
                  );
                },
            ...
            drawTitle: function drawTitle(pt, vm, ctx, opacity) {
              if (vm.title.length) {
                ...
                ctx.fillStyle = titleColor
                  .alpha(opacity * titleColor.alpha())
                  .rgbString();
                ctx.font = helpers.fontString(
                  vm.titleFontSize,
                  vm._titleFontStyle,
                ...
                function(body, i) {
                  ...
                  if (this._options.tooltips.mode !== "single") {
                    ...
                    ctx.fillStyle = helpers
                      .color(vm.bodyColor)
                      .alpha(opacity)
                      .rgbaString(); // Return fill style for text
                  }
            ...
            drawFooter: function drawFooter(pt, vm, ctx, opacity) {
              if (vm.footer.length) {
                ...
                ctx.fillStyle = footerColor
                  .alpha(opacity * footerColor.alpha())
                  .rgbString();
                ctx.font = helpers.fontString(
                  vm.footerFontSize,
                  vm._footerFontStyle,
          ...
          var DatasetScale = Chart.Scale.extend({
            ...
            getPixelForValue: function(
              ...
              if (this.isHorizontal()) {
                ...
                var widthOffset =
                  valueWidth * (index - this.minIndex) + this.paddingLeft;
                ...
                var heightOffset =
                  valueHeight * (index - this.minIndex) + this.paddingTop;
          ...
          var LinearScale = Chart.Scale.extend({
            determineDataLimits: function() {
              ...
              if (opts.stacked) {
                ...
                helpers.each(valuesPerType, function(valuesForType) {
                  ...
                  _this.min =
                    _this.min === null ? minVal : Math.min(_this.min, minVal);
                  _this.max =
                    _this.max === null ? maxVal : Math.max(_this.max, maxVal);
                });
              } else {
                helpers.each(datasets, function(dataset, datasetIndex) {
                  var meta = chart.getDatasetMeta(datasetIndex);
            ...
            buildTicks: function() {
              ...
              if (isHorizontal) {
                ...
                maxTicks = Math.min(
                  tickOpts.maxTicksLimit ? tickOpts.maxTicksLimit : 11,
                  Math.ceil(_this.height / (2 * tickFontSize))
                );
              }
            ...
            getPixelForValue: function(
              ...
              if (_this.isHorizontal()) {
                innerDimension =
                  _this.width - (paddingLeft + _this.paddingRight);
                pixel =
                  _this.left + (innerDimension / range) * (rightValue - start);
                return Math.round(pixel + paddingLeft);
              } else {
                innerDimension =
                  _this.height - (_this.paddingTop + paddingBottom);
                pixel =
                  _this.bottom -
                  paddingBottom -
            ...
            getValueForPixel: function(pixel) {
              ...
              var offset =
                (isHorizontal
                  ...
                  : _this.bottom - paddingBottom - pixel) / innerDimension;
          ...
          var LogarithmicScale = Chart.Scale.extend({
            determineDataLimits: function() {
              ...
              if (_this.min === _this.max) {
                if (_this.min !== 0 && _this.min !== null) {
                  _this.min = Math.pow(
                    10,
                    Math.floor(helpers.log10(_this.min)) - 1
                  );
                  _this.max = Math.pow(
                    10,
                    Math.floor(helpers.log10(_this.max)) + 1
                  );
                } else {
                  _this.min = 1;
                  _this.max = 10;
            ...
            buildTicks: function() {
              ...
              var tickVal = getValueOrDefault(
                tickOpts.min,
                Math.pow(10, Math.floor(helpers.log10(_this.min)))
              );
            ...
            getValueForPixel: function(pixel) {
              ...
              if (_this.isHorizontal()) {
                innerDimension =
                  _this.width - (_this.paddingLeft + _this.paddingRight);
                value =
                  _this.start *
                  Math.pow(
                    10,
                    ((pixel - _this.left - _this.paddingLeft) * range) /
                      innerDimension
                  );
              } else {
                innerDimension =
                  _this.height - (_this.paddingTop + _this.paddingBottom);
                value =
                  Math.pow(
                    10,
                    ((_this.bottom - _this.paddingBottom - pixel) * range) /
                      innerDimension
                  ) / _this.start;
              }
        ...
        module.exports = function(Chart) {
          ...
          var LinearRadialScale = Chart.Scale.extend({
            ...
            setDimensions: function() {
              ...
              var tickFontSize = helpers.getValueOrDefault(
                options.ticks.fontSize,
                globalDefaults.defaultFontSize
              );
              this.drawingArea = options.display
                ? minSize / 2 -
                  (tickFontSize / 2 + options.ticks.backdropPaddingY)
                : minSize / 2;
            },
            determineDataLimits: function() {
              this.min = null;
            ...
            buildTicks: function() {
              ...
              // Put the values into the ticks array
              this.ticks.push(
                this.options.ticks.min !== undefined
                  ? this.options.ticks.min
                  : niceMin
              );
              for (var j = 1; j < numSpaces; ++j) {
              ...
              this.ticks.push(
                this.options.ticks.max !== undefined
                  ? this.options.ticks.max
                  : niceMax
              );
              ...
              if (this.options.display) {
                ...
                helpers.each(
                  ...
                  function(label, index) {
                    ...
                    if (index > 0 || this.options.reverse) {
                      var yCenterOffset = this.getDistanceFromCenterForValue(
                        this.ticks[index]
                      );
                      ...
                      if (this.options.gridLines.display) {
                        ...
                        if (this.options.lineArc) {
                          ...
                          for (var i = 0; i < this.getValueCount(); i++) {
                            var pointPosition = this.getPointPosition(
                              i,
                      ...
                      if (this.options.ticks.display) {
                        ...
                        if (this.options.ticks.showLabelBackdrop) {
                          ...
                          ctx.fillRect(
                            ...
                            labelWidth +
                              this.options.ticks.backdropPaddingX * 2,
                            tickFontSize +
                              this.options.ticks.backdropPaddingY * 2
                          );
                        }
                ...
                if (!this.options.lineArc) {
                  ...
                  for (var i = this.getValueCount() - 1; i >= 0; i--) {
                    ...
                    var pointLabelFontColor = helpers.getValueOrDefault(
        ...
        module.exports = function(Chart) {
          ...
          var TimeScale = Chart.Scale.extend({
            ...
            getMomentStartOf: function(tick) {
              if (
                this.options.time.unit === "week" &&
                this.options.time.isoWeekday !== false
              ) {
                return tick
                  .clone()
                  .startOf("isoWeek")
            ...
            determineDataLimits: function() {
              ...
              helpers.each(
                ...
                function(dataset, datasetIndex) {
                  ...
                  var datasetVisible = this.chart.isDatasetVisible(
                    datasetIndex
                  );
                  ...
                  if (
                    ...
                    helpers.each(
                      ...
                      function(value, index) {
                        var labelMoment = this.parseTime(
                        ...
                        if (labelMoment.isValid()) {
                          ...
                          if (datasetVisible) {
                            ...
                            this.firstTick =
                              this.firstTick !== null
                                ? moment.min(this.firstTick, labelMoment)
                                : labelMoment;
                            this.lastTick =
                              this.lastTick !== null
                                ? moment.max(this.lastTick, labelMoment)
                                : labelMoment;
                          }
                        }
                      },
            ...
            buildTicks: function(index) {
              ...
              if (this.options.time.unit) {
                ...
                this.unitScale = helpers.getValueOrDefault(
                  this.options.time.unitStepSize,
                  1
                );
              } else {
                // Determine the smallest needed unit of the time
                var innerWidth = this.isHorizontal()
                  ? this.width - (this.paddingLeft + this.paddingRight)
                  : this.height - (this.paddingTop + this.paddingBottom);

                // Crude approximation of what the label length might be
                var tempFirstLabel = this.tickFormatFunction(
                  this.firstTick,
                  0,
                  []
                );
                ...
                var cosRotation = Math.cos(
                  helpers.toRadians(this.options.ticks.maxRotation)
                );
                var sinRotation = Math.sin(
                  helpers.toRadians(this.options.ticks.maxRotation)
                );
                ...
                while (unitDefinitionIndex < time.units.length) {
                  ...
                  if (
                    ...
                    Math.ceil(this.scaleSizeInUnits / labelCapacity) <
                    ...
                    var leadingUnitBuffer = this.firstTick.diff(
                      this.getMomentStartOf(this.firstTick),
                      this.tickUnit,
                      true
                    );
                    var trailingUnitBuffer = this.getMomentStartOf(
                      this.lastTick.clone().add(1, this.tickUnit)
                    ).diff(this.lastTick, this.tickUnit, true);
                    this.scaleSizeInUnits =
                      this.lastTick.diff(this.firstTick, this.tickUnit, true) +
                      leadingUnitBuffer +
                      trailingUnitBuffer;
                    this.displayFormat = this.options.time.displayFormats[
                      unitDefinition.name
              ...
              helpers.each(
                ...
                function(dataset, datasetIndex) {
                  for (
                    var i = 1;
                    i < this.labelMoments[datasetIndex].length;
                    i++
                  ) {
                    this.smallestLabelSeparation = Math.min(
                      this.smallestLabelSeparation,
                      this.labelMoments[datasetIndex][i].diff(
                        this.labelMoments[datasetIndex][i - 1],
                        this.tickUnit,
                        true
                      )
                    );
              ...
              for (var i = 1; i <= this.scaleSizeInUnits; ++i) {
                ...
                if (
                  ...
                  newTick.diff(this.lastTick, this.tickUnit, true) >= 0
                ) {
                  break;
                }
              ...
              var diff = this.ticks[this.ticks.length - 1].diff(
                this.lastTick,
                this.tickUnit
              );
            ...
            getLabelForIndex: function(index, datasetIndex) {
              var label =
                this.chart.data.labels && index < this.chart.data.labels.length
                  ? this.chart.data.labels[index]
                  : "";

              if (
                typeof this.chart.data.datasets[datasetIndex].data[0] ===
                "object"
              ) {
                label = this.getRightValue(
                  this.chart.data.datasets[datasetIndex].data[index]
                );
              }
              ...
              if (this.options.time.tooltipFormat) {
                label = this.parseTime(label).format(
            ...
            getPixelForValue: function(
              ...
              var labelMoment =
                value && value.isValid && value.isValid()
                  ? value
                  : this.getLabelMoment(datasetIndex, index);
              ...
              if (labelMoment) {
                ...
                if (this.isHorizontal()) {
                  var innerWidth =
                    this.width - (this.paddingLeft + this.paddingRight);
                  var valueWidth =
                    innerWidth / Math.max(this.ticks.length - 1, 1);
                  var valueOffset = innerWidth * decimal + this.paddingLeft;
                  ...
                  var innerHeight =
                    this.height - (this.paddingTop + this.paddingBottom);
                  var valueHeight =
                    innerHeight / Math.max(this.ticks.length - 1, 1);
            ...
            getValueForPixel: function(pixel) {
              var innerDimension = this.isHorizontal()
                ? this.width - (this.paddingLeft + this.paddingRight)
                : this.height - (this.paddingTop + this.paddingBottom);
              var offset =
                (pixel -
              ...
              return this.firstTick
                .clone()
                .add(
                  moment.duration(offset, this.tickUnit).asSeconds(),
                  "seconds"
                );
            },
            parseTime: function(label) {
              ...
              if (
                typeof this.options.time.format !== "string" &&
