                ...
                OPTIONS_REFERENCE =
                  // <JSON>
                  {
                    ...
                    valueFormatter: {
                      ...
                      type:
                        "function(num or millis, opts, seriesName, dygraph, row, col)",
                      description:
                    ...
                    ticker: {
                      ...
                      labels: ["Axis display"],
                      type:
                        "function(min, max, pixels, opts, dygraph, vals) -> [{v: ..., label: ...}, ...]",
                      parameters: [
                        ["min", ""],
                        ["max", ""],
                        ["pixels", ""],
                    ...
                    axisLabelFormatter: {
                      ...
                      labels: ["Axis display"],
                      type:
                        "function(number or Date, granularity, opts, dygraph)",
                      parameters: [
                        [
                          "number or date",
                    ...
                    file: {
                      ...
                      labels: ["Data"],
                      type:
                        "string (URL of CSV or CSV), GViz DataTable or 2D Array",
                      description:
      ...
      15: [
        function(require, module, exports) {
          (function(process) {
            ...
            var _dygraphDefaultAttrs2 = _interopRequireDefault(
              _dygraphDefaultAttrs
            );
      ...
      16: [
        function(require, module, exports) {
          ...
          var numericTicks = function numericTicks(
            ...
            var formatter = /**@type{AxisLabelFormatter}*/ opts(
              "axisLabelFormatter"
            );
          ...
          var getDateAxis = function getDateAxis(
            ...
            var date_array = [];
            date_array[DateField.DATEFIELD_Y] = accessors.getFullYear(
              start_date
            );
            date_array[DateField.DATEFIELD_M] = accessors.getMonth(start_date);
            date_array[DateField.DATEFIELD_D] = accessors.getDate(start_date);
            date_array[DateField.DATEFIELD_HH] = accessors.getHours(start_date);
            date_array[DateField.DATEFIELD_MM] = accessors.getMinutes(
              start_date
            );
            date_array[DateField.DATEFIELD_SS] = accessors.getSeconds(
              start_date
            );
            date_array[DateField.DATEFIELD_MS] = accessors.getMilliseconds(
              start_date
            );
 ...
 */ "use strict";
            ...
            var _datahandlerDefault2 = _interopRequireDefault(
              _datahandlerDefault
            );
            ...
            var _pluginsAnnotations2 = _interopRequireDefault(
              _pluginsAnnotations
            );
            ...
            var _pluginsChartLabels2 = _interopRequireDefault(
              _pluginsChartLabels
            );
             ...
             */ Dygraph.prototype.getNumericOption = function(
              ...
              return /** @type{number} */ (this.getOption(
                name,
                opt_seriesName
              ));
            };
             ...
             */ Dygraph.prototype.getStringOption = function(
              ...
              return /** @type{string} */ (this.getOption(
                name,
                opt_seriesName
              ));
            };
             ...
             */ Dygraph.prototype.getBooleanOption = function(
              ...
              return /** @type{boolean} */ (this.getOption(
                name,
                opt_seriesName
              ));
            };
             ...
             */ Dygraph.prototype.drawZoomRect_ = function(
              ...
              if (direction == utils.HORIZONTAL) {
                if (endX && startX) {
                  ctx.fillStyle = "rgba(146, 163, 185,0.33)";
                  ctx.fillRect(
            ...
            Dygraph.prototype.setXAxisOptions_ = function(isDate) {
              if (isDate) {
                ...
                /** @private (shut up, jsdoc!) */ this.attrs_.xValueParser = function(
                  x
                ) {
                  return parseFloat(x);
                }; // TODO(danvk): use Dygraph.numberValueFormatter here?
                /** @private (shut up, jsdoc!) */ this.attrs_.axes.x.valueFormatter = function(
                  x
                ) {
                  return x;
                };
             ...
             */ Dygraph.prototype.parseDataTable_ = function(data) {
              var shortTextForAnnotationNum = function shortTextForAnnotationNum(
                num
              ) {
      ...
      22: [
        function(require, module, exports) {
          ...
          chart_labels.prototype.didDrawChart = function(e) {
            ...
            if (this.ylabel_div_) {
              this.ylabel_div_.children[0].children[0].innerHTML = g.getOption(
                "ylabel"
              );
            }
            if (this.y2label_div_) {
              this.y2label_div_.children[0].children[0].innerHTML = g.getOption(
                "y2label"
              );
            }
          };
