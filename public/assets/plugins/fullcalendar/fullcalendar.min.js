...
!(function(t) {
  ...
  function O(t, e) {
    ...
    for (
      n = 0;
      n < Zt.length && ((i = Zt[n]), !((r = V(i, t, e)) >= 1 && at(r)));
      n++
    );
    return i;
  }
  ...
  function U(t, e) {
    ...
    return _(t) || _(e)
      ...
      : ((n = t.asMonths()),
        (i = e.asMonths()),
        Math.abs(n) >= 1 && at(n) && Math.abs(i) >= 1 && at(i)
          ? n / i
          : t.asDays() / e.asDays());
  }
  function W(t, n) {
  ...
  function q(t) {
    return (
      "[object Date]" === Object.prototype.toString.call(t) || t instanceof Date
    );
  }
  function Y(t) {
  ...
  function ut(t, e, n) {
    var i,
      ...
      l = function() {
        ...
        u < e
          ? (i = setTimeout(l, e - u))
          : ((i = null), n || ((a = t.apply(s, r)), (s = r = null)));
      };
    return function() {
  ...
  function vt(t, e) {
    return (
      (!t && !e) ||
      (!(!t || !e) && t.component === e.component && mt(t, e) && mt(e, t))
    );
  }
  function mt(t, e) {
    for (var n in t)
  ...
  function wt(n) {
    ...
    return (
      ...
      i &&
        ...
        delete i.duration,
        delete i.stick),
      null == r && (r = n.data(a + "start")),
      null == r && (r = n.data(a + "time")),
      null == s && (s = n.data(a + "duration")),
  ...
  function bt(e, n) {
    ...
    function r() {
      n.layout
        ? (g
            ? g.empty()
            : (g = this.el = t(
                "<div class='fc-toolbar " + n.extraClasses + "'/>"
              )),
          g
            .append(o("left"))
            .append(o("right"))
          ...
          t.each(o.split(" "), function(n) {
            ...
            t.each(this.split(","), function(n, i) {
              ...
              "title" == i
                ...
                : ((s = a[i])
                    ? ((d = function(t) {
                      ...
                      (f = r.getCustomButtonIconClass(s)) ||
                        (f = r.getIconClass(i)) ||
                        (g = s.text))
                    : (h = e.getViewSpec(i))
                    ? (p.push(i),
                      ...
                      (g = h.buttonTextOverride) ||
                        (f = r.getIconClass(i)) ||
                        (g = h.buttonTextDefault))
                    : e[i] &&
                      ((d = function() {
                        e[i]();
                      }),
                      (g = l[i]) || (f = r.getIconClass(i)) || (g = u[i])),
                  d &&
                    ((m = [
                      "fc-" + i + "-button",
                      r.getClass("button"),
                      r.getClass("stateDefault")
                    ]),
                    g
                      ? (v = et(g))
                      : f && (v = "<span class='" + f + "'></span>"),
                    (y = t(
                      ...
                      .click(function(t) {
                        y.hasClass(r.getClass("stateDisabled")) ||
                          (d(t),
                          (y.hasClass(r.getClass("stateActive")) ||
                            y.hasClass(r.getClass("stateDisabled"))) &&
                            y.removeClass(r.getClass("stateHover")));
                      })
                      .mousedown(function() {
                        y.not("." + r.getClass("stateActive"))
                          .not("." + r.getClass("stateDisabled"))
                          .addClass(r.getClass("stateDown"));
                      })
                      .mouseup(function() {
                      ...
                      .hover(
                        function() {
                          y.not("." + r.getClass("stateActive"))
                            .not("." + r.getClass("stateDisabled"))
                            .addClass(r.getClass("stateHover"));
                        },
                        function() {
                          y.removeClass(r.getClass("stateHover")).removeClass(
                            r.getClass("stateDown")
                          );
                        }
                      )),
                    (o = o.add(y))));
              ...
              c &&
                o
                  .first()
                  .addClass(r.getClass("cornerLeft"))
                  .end()
                  .last()
                  .addClass(r.getClass("cornerRight"))
                  .end(),
              o.length > 1
                ? ((i = t("<div/>")),
                  c && i.addClass(r.getClass("buttonGroup")),
                  i.append(o),
                  s.append(i))
                : s.append(o);
          }),
    ...
    function l(t) {
      g &&
        g
          .find(".fc-" + t + "-button")
          .addClass(e.theme.getClass("stateActive"));
    }
    function u(t) {
      g &&
        g
          .find(".fc-" + t + "-button")
          .removeClass(e.theme.getClass("stateActive"));
    }
    function c(t) {
      g &&
        g
          .find(".fc-" + t + "-button")
          .prop("disabled", !0)
          .addClass(e.theme.getClass("stateDisabled"));
    }
    function h(t) {
      g &&
        g
          .find(".fc-" + t + "-button")
          .prop("disabled", !1)
          .removeClass(e.theme.getClass("stateDisabled"));
    }
    function d() {
      return p;
    }
  ...
  function St(t, e) {
    ...
    for (n = 0; n < t.length; n++) {
      if (((i = t[n].eventInstance), (r = i.def), !1 === (s = r.getOverlap())))
        return !1;
  ...
  function It(t, e) {
    var n,
      ...
      r = [],
      s = e.startMs;
    for (t.sort(Ht), n = 0; n < t.length; n++)
      (i = t[n]),
        i.startMs > s && r.push(new Ue(s, i.startMs)),
        i.endMs > s && (s = i.endMs);
  ...
  function zt(t) {
    return new nn(
      new We(t.unzonedRange, t.eventDef.isAllDay()),
      t.eventDef,
      t.eventInstance
    );
  }
  ...
  function Nt(t) {
    ...
    if (void 0 === t.forwardPressure) {
      for (e = 0; e < i.length; e++)
        (n = i[e]), Nt(n), (r = Math.max(r, 1 + n.forwardPressure));
      t.forwardPressure = r;
    }
  }
  function Vt(t, e, n) {
  ...
  var Wt = (t.fullCalendar = { version: "3.6.0", internalApiVersion: 11 }),
    _t = (Wt.views = {});
      ...
      this.each(function(r, s) {
        ...
        "string" == typeof e
          ? "getCalendar" === e
            ? r || (i = l)
            : "destroy" === e
            ? l && (l.destroy(), a.removeData("fullCalendar"))
            : l
            ? t.isFunction(l[e])
              ? ((o = l[e].apply(l, n)),
                r || (i = o),
                "destroy" === e && a.removeData("fullCalendar"))
              : Wt.warn("'" + e + "' is an unknown FullCalendar method.")
            : Wt.warn(
                "Attempting to call a FullCalendar method on an element with no calendar."
              )
          : l || ((l = new Le(a, e)), a.data("fullCalendar", l), l.render());
      }),
      i
    );
  };
  ...
  (Wt.applyAll = $),
    ...
    (Wt.cssToStr = it),
    (Wt.proxy = lt),
    (Wt.capitaliseFirstLetter = st),
    (Wt.getOuterRect = d),
    (Wt.getClientRect = f),
    (Wt.getContentRect = g),
    (Wt.getScrollbarWidths = p);
  var Yt = null;
  (Wt.preventDefault = T),
    (Wt.intersectRects = I),
    (Wt.parseFieldSpecs = P),
    (Wt.compareByFieldSpecs = z),
    (Wt.compareByFieldSpec = F),
    (Wt.flexibleCompare = k),
    (Wt.computeGreatestUnit = O),
    (Wt.divideRangeByDuration = G),
    (Wt.divideDurationByDuration = U),
    (Wt.multiplyDuration = W),
    (Wt.durationHasTime = _);
  ...
  te.push("_fullCalendar"),
    ...
    (Kt.week = Kt.weeks = function(t) {
      ...
      return null == t && "function" == typeof e
        ? e(this)
        : "ISO" === e
        ? Jt.isoWeek.apply(this, arguments)
        : Jt.week.apply(this, arguments);
    }),
    (Kt.time = function(t) {
    ...
    (Kt.local = function(t) {
      return (
        Jt.local.call(this, this._ambigZone || t),
        (this._ambigTime = !1),
        (this._ambigZone = !1),
        this
      );
    ...
    (Kt.utcOffset = function(t) {
      return (
        ...
        Jt.utcOffset.apply(this, arguments)
      );
    }),
    (Kt.format = function() {
      return this._fullCalendar && arguments[0]
        ? ee(this, arguments[0])
        : this._ambigTime
        ? ie(ht(this), "YYYY-MM-DD")
        : this._ambigZone
        ? ie(ht(this), "YYYY-MM-DD[T]HH:mm:ss")
        : this._fullCalendar
        ? ie(ht(this))
        : Jt.format.apply(this, arguments);
    }),
    (Kt.toISOString = function() {
      return this._ambigTime
        ...
        ? ie(ht(this), "YYYY-MM-DD[T]HH:mm:ss")
        : this._fullCalendar
        ? Jt.toISOString.apply(ht(this), arguments)
        : Jt.toISOString.apply(this, arguments);
    }),
    (function() {
      function t(t, e) {
      ...
      function n(t, e, n, s, o) {
        var a;
        return (
          (t = Wt.moment.parseZone(t)),
          (e = Wt.moment.parseZone(e)),
          (a = t.localeData()),
      ...
      function i(t, e, n, i, r) {
        var s,
          ...
          y = "",
          w = "";
        for (s = 0; s < l.length && (!l[s] || u.isSame(c, l[s])); s++)
          p += f[s];
        for (
          o = l.length - 1;
          o > s &&
      ...
      function u(t) {
        ...
        for (e = 0; e < t.length; e++)
          (n = t[e]),
            n.token
              ? ((i = w[n.token.charAt(0)]), r.push(i ? i.unit : "second"))
              : n.maybe
              ? r.push.apply(r, u(n.maybe))
              : r.push(null);
        return r;
      }
      function c(t, e) {
      ...
      function h(t, n) {
        ...
        for (i = 0; i < a.length; i++)
          (r = a[i]),
            r.charAt(0) === p ? s.push(y[r.substring(1)](n)) : s.push(r);
        return s;
      }
      function d(t) {
      ...
      (Wt.formatDate = t),
        (Wt.formatRange = n),
        (Wt.oldMomentFormat = e),
        (Wt.queryMostGranularFormatUnit = f);
      var g = "\v",
        p = "",
        v = "",
  ...
  var re = (Wt.EmitterMixin = {
      ...
      return {
        ...
        listenTo: function(e, n, i) {
          if ("object" == typeof n)
            ...
            "string" == typeof n &&
              e.on(n + "." + this.getListenerNamespace(), t.proxy(i, this));
        },
    ...
    ue = dt.extend(re, se, {
      ...
      _watchDeps: function(t, e, n) {
        ...
        function r(t, n, i) {
          void 0 === n
            ? (i || void 0 === c[t] || u--, delete c[t])
            : (i || void 0 !== c[t] || u++, (c[t] = n)),
            --a || (u === l && (d || e(c)));
        }
        function s(t, e) {
          o.on(t, e), h.push([t, e]);
  ...
  (ue.watch = function(t) {
    this.prototype.hasOwnProperty("_globalWatchArgs") ||
      ...
      (this.prototype._globalWatchArgs[t] = arguments);
  }),
    (Wt.Model = ue);
  var ce = {
  ...
  var he = dt.extend(re, {
    ...
    tryStart: function() {
      !this.isRunning &&
        this.canRunNext() &&
        ((this.isRunning = !0), this.trigger("start"), this.runRemaining());
    },
    canRunNext: function() {
  ...
  var fe = dt.extend(se, {
      ...
      render: function() {
        ...
        (this.el = t('<div class="fc-popover"/>')
          ...
          n.autoHide &&
            this.listenTo(t(document), "mousedown", this.documentMousedown);
      },
      ...
      position: function() {
        ...
        (r = o.top || 0),
          (s =
            void 0 !== o.left ? o.left : void 0 !== o.right ? o.right - l : 0),
          d.is(window) || d.is(document)
            ? ((d = c), (e = 0), (n = 0))
            : ((i = d.offset()), (e = i.top), (n = i.left)),
          (e += c.scrollTop()),
          (n += c.scrollLeft()),
          !1 !== o.viewportConstrain &&
            ((r = Math.min(r, e + d.outerHeight() - u - this.margin)),
            (r = Math.max(r, e + this.margin)),
            (s = Math.min(s, n + d.outerWidth() - l - this.margin)),
            (s = Math.max(s, n + this.margin))),
          this.el.css({ top: r - a.top, left: s - a.left });
      },
      trigger: function(t) {
        this.options[t] &&
    ...
    ge = (Wt.CoordCache = dt.extend({
      ...
      queryBoundingRect: function() {
        var t;
        return this.els.length > 0 && ((t = h(this.els.eq(0))), !t.is(document))
          ? f(t)
          : null;
      },
    ...
    pe = (Wt.DragListener = dt.extend(se, {
      ...
      startInteraction: function(e, n) {
        ...
        this.isInteracting ||
          ((n = n || {}),
          (this.delay = tt(n.delay, this.options.delay, 0)),
          (this.minDistance = tt(n.distance, this.options.distance, 0)),
      ...
      trigger: function(t) {
        this.options[t] &&
          this.options[t].apply(this, Array.prototype.slice.call(arguments, 1)),
          this["_" + t] &&
            this["_" + t].apply(this, Array.prototype.slice.call(arguments, 1));
      }
    }));
  pe.mixin({
    isAutoScroll: !1,
    ...
    initAutoScroll: function() {
      ...
      (this.isAutoScroll =
        ...
        this.isAutoScroll &&
          this.listenTo(t, "scroll", ut(this.handleDebouncedScroll, 100));
    },
  ...
  var ve = pe.extend({
        ...
        t
          ? ((n = { left: b(t), top: E(t) }),
            ...
            r &&
              ...
              (this.origHit && (e = I(this.origHit, e) || e), (i = M(e))),
            (this.coordAdjust = x(i, n)))
          : ((this.origHit = null), (this.coordAdjust = null)),
        pe.prototype.handleInteractionStart.apply(this, arguments);
    },
    handleDragStart: function(t) {
      var e;
      pe.prototype.handleDragStart.apply(this, arguments),
        (e = this.queryHit(b(t), E(t))) && this.handleHitOver(e);
    },
    handleDrag: function(t, e, n) {
      var i;
      pe.prototype.handleDrag.apply(this, arguments),
        (i = this.queryHit(b(n), E(n))),
        vt(i, this.hit) ||
          (this.hit && this.handleHitOut(), i && this.handleHitOver(i));
    },
    ...
    handleInteractionEnd: function() {
      pe.prototype.handleInteractionEnd.apply(this, arguments),
        (this.origHit = null),
        (this.hit = null),
        this.component.hitsNotNeeded();
    },
    handleScrollEnd: function() {
      pe.prototype.handleScrollEnd.apply(this, arguments),
        this.isDragging &&
    ...
    bind: function() {
      ...
      this.listenTo(t(document), {
        ...
        window.addEventListener(
          "touchmove",
          (this.handleTouchMoveProxy = function(n) {
        ...
        window.addEventListener(
          "scroll",
          (this.handleScrollProxy = function(n) {
  ...
  var ye = dt.extend(se, {
      ...
      start: function(e) {
        this.isFollowing ||
          ...
          S(e)
            ? this.listenTo(t(document), "touchmove", this.handleMove)
            : this.listenTo(t(document), "mousemove", this.handleMove));
      },
      stop: function(e, n) {
        function i() {
          (r.isAnimating = !1),
  ...
  var De = dt.extend({
        ...
        var t,
          ...
          i = new ve(n, {
            ...
            interactionEnd: function(i, r) {
              ...
              !r &&
                t &&
                (s = n.getSafeHitFootprint(t)) &&
                e.view.triggerDayClick(s, n.getHitEl(t), i);
            }
          });
    ...
    Ee = (Wt.DateSelecting = De.extend({
      ...
      bindToEl: function(t) {
        ...
        n.bindDateHandlerToEl(t, "mousedown", function(t) {
          e.opt("selectable") &&
            !n.shouldIgnoreMouse() &&
            i.startInteraction(t, { distance: e.opt("selectMinDistance") });
        }),
      ...
      buildDragListener: function() {
        ...
        return new ve(n, {
          ...
          hitOver: function(i, r, o) {
            var a, l;
            o &&
              ((a = n.getSafeHitFootprint(o)),
              (l = n.getSafeHitFootprint(i)),
              (t = a && l ? e.computeSelection(a, l) : null),
              t ? n.renderSelectionFootprint(t) : !1 === t && s());
          },
          hitOut: function() {
      ...
      isSelectionFootprintAllowed: function(t) {
        return (
          this.component.dateProfile.validUnzonedRange.containsRange(
            t.unzonedRange
          ) && this.view.calendar.isSelectionFootprintAllowed(t)
        );
      }
    })),
      ...
      buildDragListener: function(t) {
        ...
        var g = (this.dragListener = new ve(l, {
          ...
          dragStart: function(n) {
            g.isTouch &&
              !l.isEventDefSelected(d) &&
              f &&
              l.selectEventInstance(f),
              (e = !0),
              r.eventPointing.handleMouseout(t, n),
              r.segDragStart(t, n),
              l.hideEventsWithId(t.footprint.eventDef.id);
          },
          hitOver: function(e, o, h) {
            var f,
              ...
              m = !0;
            t.hit && (h = t.hit),
              (f = h.component.getSafeHitFootprint(h)),
              (p = e.component.getSafeHitFootprint(e)),
              f && p
                ? ((i = r.computeEventDropMutation(f, p, d)),
                  i
                    ? ((v = c.buildMutatedEventInstanceGroup(d.id, i)),
                      (m = a.isEventInstanceGroupAllowed(v)))
                    : (m = !1))
                : (m = !1),
              m || ((i = null), s()),
              i &&
              l.renderDrag(
                a.eventRangesToEventFootprints(
                  v.sliceRenderRanges(a.dateProfile.renderUnzonedRange, u)
                ),
                t,
                g.isTouch
              )
          ...
          interactionEnd: function(s) {
            delete t.component,
              n.stop(!i, function() {
                e && (l.unrenderDrag(t), r.segDragStop(t, s)),
                  l.showEventsWithId(t.footprint.eventDef.id),
                  i && l.reportEventDrop(f, i, h, s);
              }),
              (r.dragListener = null);
          }
        }));
      ...
      computeEventDateMutation: function(t, e) {
        ...
        return (
          t.isAllDay !== e.isAllDay &&
            ((o = !0), e.isAllDay ? ((l = !0), r.stripTime()) : (a = !0)),
          (n = this.component.diffDates(s, r)),
          (i = new sn()),
          (i.clearEnd = o),
          (i.forceTimed = a),
          (i.forceAllDay = l),
    ...
    Ce = (Wt.EventResizing = De.extend({
      ...
      handleMouseDown: function(e, n) {
        this.component.canStartResize(e, n) &&
          this.buildDragListener(
            e,
            t(n.target).is(".fc-start-resizer")
          ).startInteraction(n, { distance: 5 });
      },
      ...
      buildDragListener: function(t, e) {
        ...
        return (this.dragListener = new ve(a, {
          ...
          hitOver: function(n, o, h) {
            ...
            p && v
              ? ((i = e
                  ? r.computeEventStartResizeMutation(p, v, t.footprint)
                  : r.computeEventEndResizeMutation(p, v, t.footprint)),
                i
                  ? ((f = c.buildMutatedEventInstanceGroup(d.id, i)),
                    (g = a.isEventInstanceGroupAllowed(f)))
                  : (g = !1))
              : (g = !1),
              g ? i.isEmpty() && (i = null) : ((i = null), s()),
              i &&
                (l.hideEventsWithId(t.footprint.eventDef.id),
                l.renderEventResize(
                  a.eventRangesToEventFootprints(
                    f.sliceRenderRanges(a.dateProfile.renderUnzonedRange, u)
                  ),
                  t
                ));
          },
          ...
          hitDone: function() {
            l.unrenderEventResize(t),
              l.showEventsWithId(t.footprint.eventDef.id),
              o();
          },
          interactionEnd: function(e) {
            n && r.segResizeStop(t, e),
              i && l.reportEventResize(f, i, h, e),
              (r.dragListener = null);
          }
        }));
      },
      ...
      computeEventStartResizeMutation: function(t, e, n) {
        var i,
          r,
          s = n.componentFootprint.unzonedRange,
          o = this.component.diffDates(
            e.unzonedRange.getStart(),
            t.unzonedRange.getStart()
          );
        return (
          s.getStart().add(o) < s.getEnd() &&
          ((i = new sn()),
          i.setStartDelta(o),
          (r = new rn()),
          r.setDateMutation(i),
    ...
    Re = (Wt.ExternalDropping = De.extend(se, {
      ...
      handleDragStart: function(e, n) {
        ...
        this.opt("droppable") &&
          ...
          (t.isFunction(r) ? r.call(i[0], i) : i.is(r)) &&
            (this.isDragging || this.listenToExternalDrag(i, e, n)));
      },
      listenToExternalDrag: function(t, e, n) {
        ...
        (r.dragListener = new ve(a, {
          ...
          hitOver: function(t) {
            ...
            o
              ? ((i = r.computeExternalDrop(o, u)),
                i
                  ? ((e = new Je(i.buildInstances())),
                    (n = u.eventProps
                      ? a.isEventInstanceGroupAllowed(e)
                      : a.isExternalInstanceGroupAllowed(e)))
                  : (n = !1))
              : (n = !1),
              n || ((i = null), s()),
              i &&
                a.renderDrag(
                  a.eventRangesToEventFootprints(
                    e.sliceRenderRanges(
                      a.dateProfile.renderUnzonedRange,
                      l.calendar
                    )
                  )
                );
      ...
      computeExternalDrop: function(e, n) {
        ...
        return (
          e.isAllDay && (n.startTime ? s.time(n.startTime) : s.stripTime()),
          n.duration && (i = s.clone().add(n.duration)),
          (s = r.applyTimezone(s)),
          i && (i = r.applyTimezone(i)),
          $e.parse(t.extend({}, n.eventProps, { start: s, end: i }), new on(r))
        );
      }
    }));
  Wt.dataAttrPrefix = "";
  var Te = (Wt.EventPointing = De.extend({
    ...
    He = (Wt.EventRenderer = dt.extend({
      ...
      renderFgSegEls: function(e, n) {
        ...
        if (e.length) {
          for (i = 0; i < e.length; i++)
            this.beforeFgSegHtml(e[i]), (o += this.fgSegHtml(e[i], n));
          t(o).each(function(n, i) {
            var o = e[n],
              l = t(i);
            s && (l = r.filterEventRenderEl(o.footprint, l)),
              l && (l.data("fc-seg", o), (o.el = l), a.push(o));
          });
        }
        return a;
      },
      ...
      getBgColor: function(t) {
        ...
        for (e = 0; e < i.length && !n; e++)
          n =
            ...
            i[e].color;
        return (
          n || (n = this.opt("eventBackgroundColor") || this.opt("eventColor")),
          n
        );
      },
      getBorderColor: function(t) {
        ...
        for (e = 0; e < i.length && !n; e++)
          n =
            ...
            i[e].color;
        return (
          n || (n = this.opt("eventBorderColor") || this.opt("eventColor")), n
        );
      },
      ...
      compareEventSegs: function(t, e) {
        ...
        return (
          i.startMs - s.startMs ||
          s.endMs - s.startMs - (i.endMs - i.startMs) ||
          r.isAllDay - n.isAllDay ||
          z(
    ...
    xe = (Wt.FillRenderer = dt.extend({
      ...
      buildSegEls: function(e, n, i) {
        ...
        if (n.length) {
          ...
          t(o).each(function(e, r) {
            var o = n[e],
              l = t(r);
            i.filterEl && (l = i.filterEl(o, l)),
              l && ((l = t(l)), l.is(s.fillSegTag) && ((o.el = l), a.push(o)));
          });
        }
        return a;
      },
      ...
      reportEls: function(e, n) {
        this.elsByFill[e]
          ? (this.elsByFill[e] = this.elsByFill[e].add(n))
          : (this.elsByFill[e] = t(n));
      }
    })),
    Pe = (Wt.HelperRenderer = dt.extend({
      ...
      renderEventFootprints: function(t, e, n, i) {
        var r,
          s = this.component.eventFootprintsToSegs(t),
          o = "fc-helper " + (n || "");
        for (s = this.eventRenderer.renderFgSegEls(s), r = 0; r < s.length; r++)
          s[r].el.addClass(o);
    ...
    Fe = (Wt.DateComponent = ze.extend({
      ...
      constructor: function() {
        ze.call(this),
          (this.uid = String(Fe.guid++)),
          (this.childrenByUid = {}),
          (this.nextDayThreshold = e.duration(this.opt("nextDayThreshold"))),
          (this.isRTL = this.opt("isRTL")),
          this.fillRendererClass &&
            (this.fillRenderer = new this.fillRendererClass(this)),
          this.eventRendererClass &&
            (this.eventRenderer = new this.eventRendererClass(
              this,
              this.fillRenderer
            )),
          this.helperRendererClass &&
            this.eventRenderer &&
            (this.helperRenderer = new this.helperRendererClass(
              this,
              this.eventRenderer
            )),
          this.businessHourRendererClass &&
            this.fillRenderer &&
            (this.businessHourRenderer = new this.businessHourRendererClass(
              this,
              this.fillRenderer
            ));
      },
      addChild: function(t) {
        return (
          !this.childrenByUid[t.uid] && ((this.childrenByUid[t.uid] = t), !0)
        );
      },
      removeChild: function(t) {
        return (
          !!this.childrenByUid[t.uid] && (delete this.childrenByUid[t.uid], !0)
        );
      },
      ...
      executeEventRender: function(t) {
        this.eventRenderer
          ? (this.eventRenderer.rangeUpdated(), this.eventRenderer.render(t))
          : this.renderEvents && this.renderEvents(Dt(t)),
      ...
      getSafeHitFootprint: function(t) {
        ...
        return this.dateProfile.activeUnzonedRange.containsRange(e.unzonedRange)
          ? e
          : null;
      },
      ...
      eventFootprintToSegs: function(t, e) {
        var n,
          i,
          r,
          s = t.componentFootprint.unzonedRange;
        for (
          e && (s = s.intersect(e)),
  ...
  (Fe.guid = 0),
    Fe.mixin({
      buildGotoAnchorHtml: function(e, n, i) {
        ...
        return (
          t.isPlainObject(e)
            ...
            : (r = e),
          (r = Wt.moment(r)),
          (a = { date: r.format("YYYY-MM-DD"), type: s || "day" }),
      ...
      formatRange: function(t, e, n, i) {
        var r = t.end;
        return (
          e && (r = r.clone().subtract(1)), ne(t.start, r, n, i, this.isRTL)
        );
      },
      ...
      computeDayRange: function(t) {
        var e = this._getCalendar(),
          ...
          s = i.clone().stripTime();
        return (
          r && r >= this.nextDayThreshold && s.add(1, "days"),
          s <= n && (s = n.clone().add(1, "days")),
          { start: n, end: s }
        );
      },
  ...
  var ke = (Wt.InteractiveDateComponent = Fe.extend({
      ...
      constructor: function() {
        Fe.call(this),
          this.dateSelectingClass &&
            (this.dateClicking = new this.dateClickingClass(this)),
          this.dateSelectingClass &&
            (this.dateSelecting = new this.dateSelectingClass(this)),
          this.eventPointingClass &&
            (this.eventPointing = new this.eventPointingClass(this)),
          this.eventDraggingClass &&
            this.eventPointing &&
            (this.eventDragging = new this.eventDraggingClass(
              this,
              this.eventPointing
            )),
          this.eventResizingClass &&
            this.eventPointing &&
            (this.eventResizing = new this.eventResizingClass(
              this,
              this.eventPointing
            )),
          this.externalDroppingClass &&
            (this.externalDropping = new this.externalDroppingClass(this));
      },
      setElement: function(t) {
        Fe.prototype.setElement.apply(this, arguments),
      ...
      executeEventUnrender: function() {
        this.endInteractions(),
          Fe.prototype.executeEventUnrender.apply(this, arguments);
      },
      bindGlobalHandlers: function() {
        Fe.prototype.bindGlobalHandlers.apply(this, arguments),
          this.externalDropping && this.externalDropping.bindToDocument();
      },
      unbindGlobalHandlers: function() {
        Fe.prototype.unbindGlobalHandlers.apply(this, arguments),
      ...
      bindDateHandlerToEl: function(e, n, i) {
        ...
        this.el.on(n, function(e) {
          if (
            !t(e.target).is(
              r.segSelector + "," + r.segSelector + " *,.fc-more,a[data-goto]"
            )
          )
            return i.call(r, e);
        });
      ...
      bindAllSegHandlersToEl: function(t) {
        [this.eventPointing, this.eventDragging, this.eventResizing].forEach(
          function(e) {
            e && e.bindToEl(t);
          }
        );
      ...
      isEventDefResizableFromStart: function(t) {
        return (
          this.opt("eventResizableFromStart") && this.isEventDefResizable(t)
        );
      },
      ...
      isExternalInstanceGroupAllowed: function(t) {
        ...
        for (e = 0; e < r.length; e++)
          if (
            ...
            return !1;
        for (e = 0; e < r.length; e++)
          if (!n.calendar.isSelectionFootprintAllowed(r[e].componentFootprint))
            return !1;
        return !0;
      }
    })),
    Be = (Wt.DayTableMixin = {
      ...
      updateDayTable: function() {
        for (
          var t,
            ...
            o = r.msToUtcMoment(this.dateProfile.renderUnzonedRange.endMs, !0),
            a = -1,
            l = [],
            u = [];
          s.isBefore(o);
      ...
      renderHeadDateCellHtml: function(t, e, n) {
        ...
        return (
          1 === this.rowCnt
            ? (s = s.concat(this.getDayClasses(t, !0)))
            : s.push("fc-" + jt[t.day()]),
          '<th class="' +
            s.join(" ") +
            '"' +
            ...
            (r
              ? i.buildGotoAnchorHtml(
                  { date: t, forceOff: this.rowCnt > 1 || 1 === this.colCnt },
                  o
                )
              : o) +
            "</th>"
      ...
      renderBgCellHtml: function(t, e) {
        ...
        return (
          r.unshift("fc-day", n.calendar.theme.getClass("widgetContent")),
          '<td class="' +
            r.join(" ") +
            '"' +
    ...
    Ae = (Wt.View = ke.extend({
      ...
      constructor: function(t, e) {
        (this.calendar = t),
          ...
          (this.eventOrderSpecs = P(this.opt("eventOrder"))),
      ...
      initRenderQueue: function() {
        (this.renderQueue = new de({ event: this.opt("eventRenderWait") })),
      ...
      executeDateRender: function(t) {
        Fe.prototype.executeDateRender.apply(this, arguments),
      ...
      executeDateUnrender: function() {
        this.unselect(),
          ...
          Fe.prototype.executeDateUnrender.apply(this, arguments);
      },
      ...
      bindGlobalHandlers: function() {
        ke.prototype.bindGlobalHandlers.apply(this, arguments),
          this.listenTo(me.get(), {
            touchstart: this.processUnselect,
            mousedown: this.handleDocumentMousedown
          });
      },
      unbindGlobalHandlers: function() {
        ke.prototype.unbindGlobalHandlers.apply(this, arguments),
          this.stopListeningTo(me.get());
      },
      ...
      updateSize: function(t, e, n) {
        this.setHeight
          ? this.setHeight(t, e)
          : ke.prototype.updateSize.apply(this, arguments),
      ...
      applyScroll: function(e) {
        e.isDateInit &&
          this.isDatesRendered &&
          t.extend(e, this.computeInitialDateScroll()),
      ...
      reportEventDrop: function(t, n, i, r) {
        var s = this.calendar.eventManager,
          ...
          a = n.dateMutation;
        a &&
          (t.dateProfile = a.buildNewDateProfile(t.dateProfile, this.calendar)),
          this.triggerEventDrop(t, (a && a.dateDelta) || e.duration(), o, i, r);
      },
      ...
      reportExternalDrop: function(t, e, n, i, r, s) {
        e && this.calendar.eventManager.addEventDef(t, n),
          this.triggerExternalDrop(t, e, i, r, s);
      },
      ...
      reportEventResize: function(t, e, n, i) {
        ...
        (t.dateProfile = e.dateMutation.buildNewDateProfile(
          ...
          this.triggerEventResize(t, e.dateMutation.endDelta, s, n, i);
      },
      ...
      renderSelectionFootprint: function(t, e) {
        this.renderSelection
          ...
          : ke.prototype.renderSelectionFootprint.apply(this, arguments);
      },
      ...
      unselect: function(t) {
        this.isSelected &&
          ...
          this.publiclyTrigger("unselect", { context: this, args: [t, this] }));
      },
    ...
    Ae.mixin({
      ...
      buildDateProfile: function(t, n, i) {
        ...
        return (
          ...
          i && (t = this.calendar.msToUtcMoment(r.constrainDate(t), c)),
          (s = this.buildCurrentRangeInfo(t, n)),
          (o = /^(year|month|week|day)$/.test(s.unit)),
          ...
          (l = a.clone()),
          this.opt("showNonCurrentDates") || (l = l.intersect(s.unzonedRange)),
          (h = e.duration(this.opt("minTime"))),
          (d = e.duration(this.opt("maxTime"))),
          (l = this.adjustActiveRange(l, h, d)),
          (l = l.intersect(r)),
          l && (t = this.calendar.msToUtcMoment(l.constrainDate(t), c)),
          (u = s.unzonedRange.intersectsWith(r)),
          {
            validUnzonedRange: r,
      ...
      buildValidRange: function() {
        return (
          this.getUnzonedRangeOption("validRange", this.calendar.getNow()) ||
          new Ue()
        );
      },
      buildCurrentRangeInfo: function(t, e) {
        var n,
          ...
          s = null;
        return (
          this.viewSpec.duration
            ? ((i = this.viewSpec.duration),
              (r = this.viewSpec.durationUnit),
              (s = this.buildRangeFromDuration(t, e, i, r)))
            : (n = this.opt("dayCount"))
            ? ((r = "day"), (s = this.buildRangeFromDayCount(t, e, n)))
            : (s = this.buildCustomVisibleRange(t))
            ? (r = O(s.getStart(), s.getEnd()))
            : ((i = this.getFallbackDuration()),
              (r = O(i)),
              (s = this.buildRangeFromDuration(t, e, i, r))),
          { duration: i, unit: r, unzonedRange: s }
        );
      },
      ...
      buildRangeFromDuration: function(t, n, i, r) {
        ...
        return (
          i.as("days") <= 1 &&
            this.isHiddenDay(u) &&
            ((u = this.skipHiddenDays(u, n)), u.startOf("day")),
          l ||
            ((o = this.opt("dateIncrement")),
            o ? ((a = e.duration(o)), (l = a < i ? N(a, o) : r)) : (l = r)),
          u.startOf(l),
          (s = u.clone().add(i)),
          new Ue(u, s)
        );
      ...
      buildCustomVisibleRange: function(t) {
        var e = this.getUnzonedRangeOption(
          "visibleRange",
          this.calendar.applyTimezone(t)
        );
  ...
  var Le = (Wt.Calendar = dt.extend(re, se, {
    ...
    publiclyTrigger: function(e, n) {
      ...
      if (
        (t.isPlainObject(n)
          ? ((i = n.context), (r = n.args))
          : t.isArray(n) && (r = n),
        null == i && (i = this.el[0]),
        r || (r = []),
        this.triggerWith(e, i, r),
        s)
      )
        return s.apply(i, r);
    },
    ...
    changeView: function(t, e) {
      e &&
        (e.start && e.end
          ? this.recordOptionOverrides({ visibleRange: e })
    ...
    parseUnzonedRange: function(t) {
      ...
      return (
        ...
        e || n ? (e && n && n.isBefore(e) ? null : new Ue(e, n)) : null
      );
    },
  ...
  Le.mixin({
    ...
    setOptions: function(t) {
      ...
      if (1 === n) {
        if ("height" === e || "contentHeight" === e || "aspectRatio" === e)
          return void this.updateViewSize(!0);
    ...
    populateOptionsHash: function() {
      var t, e, i, r, s;
      (t = tt(this.dynamicOverrides.locale, this.overrides.locale)),
        (e = Oe[t]),
        e || ((t = Le.defaults.locale), (e = Oe[t] || {})),
        (i = tt(
        ...
        (s = n([Le.defaults, r, e, this.overrides, this.dynamicOverrides])),
        Rt(s),
        this.optionsModel.reset(s);
    },
    ...
    Le.mixin({
        ...
        (this.defaultAllDayEventDuration = e.duration(
          ...
          this.optionsModel.watch(
            ...
            function(e) {
              ...
              e.monthNames && (s._months = e.monthNames),
                e.monthNamesShort && (s._monthsShort = e.monthNamesShort),
                e.dayNames && (s._weekdays = e.dayNames),
                e.dayNamesShort && (s._weekdaysShort = e.dayNamesShort),
                null == r && "ISO" === i && (r = 1),
                null != r &&
                  ((n = Object.create(s._week)), (n.dow = r), (s._week = n)),
                ("ISO" !== i && "local" !== i && "function" != typeof i) ||
                  (s._fullCalendar_weekCalc = i),
                (t.localeData = s),
      ...
      moment: function() {
        ...
        return (
          "local" === this.opt("timezone")
            ? ((t = Wt.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
      ...
      getIsAmbigTimezone: function() {
        return (
          "local" !== this.opt("timezone") && "UTC" !== this.opt("timezone")
        );
      },
      applyTimezone: function(t) {
        ...
        var e,
          ...
          i = t.time() - n.time();
        return (
          i && ((e = n.clone().add(i)), t.time() - e.time() == 0 && (n = e)), n
        );
      },
      footprintToDateProfile: function(t, e) {
        var n,
          i = Wt.moment.utc(t.unzonedRange.startMs);
        return (
          e || (n = Wt.moment.utc(t.unzonedRange.endMs)),
          t.isAllDay
            ? (i.stripTime(), n && n.stripTime())
            : ((i = this.applyTimezone(i)), n && (n = this.applyTimezone(n))),
          new tn(i, n, this)
        );
      },
      getNow: function() {
        ...
        for (
          ...
          (i = _t[d]),
            ...
            i &&
              ...
              (s = s || i.duration),
              (d = d || i.type)),
            r && (h.unshift(r), (s = s || r.duration), (d = d || r.type));
        return (
          (i = j(u)),
          (i.type = t),
          !!i.class &&
            ((s =
              s || this.dynamicOverrides.duration || this.overrides.duration),
            s &&
              ((o = e.duration(s)),
              o.valueOf() &&
                ((a = N(o, s)),
                (i.duration = o),
                (i.durationUnit = a),
                1 === o.as(a) && ((i.singleUnit = a), h.unshift(l[a] || {})))),
            (i.defaults = n(c)),
            (i.overrides = n(h)),
    ...
    Le.mixin({
      ...
      render: function() {
        this.contentEl
          ? this.elementVisible() && (this.calcSize(), this.renderView())
          : this.initialRender();
      },
      initialRender: function() {
        ...
        n.addClass("fc"),
          n.on("click.fc", "a[data-goto]", function(n) {
            ...
            "function" == typeof a
              ? a(s, n)
              : ("string" == typeof a && (o = a), e.zoomTo(s, o));
          }),
          this.optionsModel.watch(
            "settingTheme",
            ["?theme", "?themeSystem"],
          ...
          this.optionsModel.watch(
            ...
            ["?businessHours"],
            function(t) {
              (e.businessHourGenerator = new je(t.businessHours, e)),
                e.view &&
                  e.view.set("businessHourGenerator", e.businessHourGenerator);
            },
            function() {
      ...
      destroy: function() {
        this.view && this.clearView(),
          ...
          this.windowResizeProxy &&
            (t(window).unbind("resize", this.windowResizeProxy),
      ...
      renderView: function(e) {
        ...
        this.freezeContentHeight(),
          i && e && i.type !== e && this.clearView(),
          !this.view &&
            e &&
            ((n = this.view =
              this.viewsByType[e] ||
              (this.viewsByType[e] = this.instantiateView(e))),
            this.bindViewHandlers(n),
            n.setElement(
      ...
      isHeightAuto: function() {
        return (
          "auto" === this.opt("contentHeight") || "auto" === this.opt("height")
        );
      },
    ...
    Le.mixin({
      ...
      initToolbars: function() {
        (this.header = new bt(this, this.computeHeaderOptions())),
          (this.footer = new bt(this, this.computeFooterOptions())),
          (this.toolbarsManager = new yt([this.header, this.footer]));
      },
      ...
      updateToolbarButtons: function(t) {
        ...
        this.toolbarsManager.proxyCall(
          ...
          this.toolbarsManager.proxyCall(
            s.isValid ? "enableButton" : "disableButton",
            "next"
          );
      },
    ...
    (Le.prototype.isEventInstanceGroupAllowed = function(t) {
      ...
      if (u)
        for (e = 0; e < i.length; e++)
          if (
            !1 ===
            u(i[e].componentFootprint.toLegacy(this), i[e].getEventLegacy())
          )
            return !1;
      return !0;
    }),
    ...
    (Le.prototype.isSelectionFootprintAllowed = function(t) {
      ...
      return (
        ...
        (!(e = this.opt("selectAllow")) || !1 !== e(t.toLegacy(this)))
      );
    }),
    (Le.prototype.isFootprintAllowed = function(t, e, n, i, r) {
      ...
      if (
        null != n &&
        ((s = this.constraintValToFootprints(n, t.isAllDay)),
        !this.isFootprintWithinConstraints(t, s))
      )
        return !1;
    ...
    (Le.prototype.constraintValToFootprints = function(t, e) {
      ...
      return "businessHours" === t
        ...
        ? ((n = this.parseEventDefToInstances(t)),
          n ? this.eventInstancesToFootprints(n) : this.parseFootprints(t))
        : null != t
    ...
    (Le.prototype.parseFootprints = function(t) {
      var e, n;
      return (
        t.start && ((e = this.moment(t.start)), e.isValid() || (e = null)),
        t.end && ((n = this.moment(t.end)), n.isValid() || (n = null)),
        [new We(new Ue(e, n), (e && !e.hasTime()) || (n && !n.hasTime()))]
      );
    }),
    ...
    Le.mixin({
      ...
      removeEvents: function(t) {
        ...
        if (null == t) i.removeAllEventDefs(!0);
          ...
          for (
            ...
            (e = this.eventManager.getEventDefByUid(r[n]._id)), (s[e.id] = !0);
          i.freeze();
      ...
      updateEvent: function(t) {
        ...
        i instanceof $e &&
          ((e = i.buildInstance()),
          (n = rn.createFromRawProps(e, t, null)),
    ...
    (Le.englishDefaults = { dayPopoverFormat: "dddd, MMMM D" }),
    (Le.rtlDefaults = {
  ...
  var Ue = (Wt.UnzonedRange = dt.extend({
      ...
      intersectsWith: function(t) {
        return (
          ...
          (null === this.startMs || null === t.endMs || this.startMs < t.endMs)
        );
      },
      containsRange: function(t) {
        return (
          ...
          (null === this.endMs || (null !== t.endMs && t.endMs <= this.endMs))
        );
      },
      ...
      getStart: function() {
        if (null !== this.startMs)
          return Wt.moment.utc(this.startMs).stripZone();
      },
      getEnd: function() {
    ...
    _e = dt.extend(re, {
      ...
      purgeSource: function(t) {
        ...
        e &&
          ...
          "pending" === e.status
            ? ((e.status = "cancelled"), this.pendingCnt--, this.tryRelease())
            : "completed" === e.status &&
      ...
      removeEventInstancesForDef: function(t) {
        var e,
          ...
          i = n[t.id];
        i &&
          ((e = X(i.eventInstances, function(e) {
            return e.def === t;
          })),
      ...
      whenReleased: function() {
        ...
        return this.releaseCnt
          ? ce.resolve(this.eventInstanceGroupsById)
          : ce.construct(function(e) {
              t.one("release", e);
            });
      },
      freeze: function() {
    ...
    qe = dt.extend(re, se, {
      ...
      querySources: function(e) {
        ...
        return (i = this.getSourceById(on.normalizeId(e)))
          ? [i]
          : ((e = an.parse(e, this.calendar)),
            e
              ? t.grep(r, function(t) {
                  return Mt(e, t);
                })
      ...
      setPeriod: function(t) {
        this.currentPeriod &&
          (this.unbindPeriod(this.currentPeriod), (this.currentPeriod = null)),
      ...
      buildMutatedEventInstanceGroup: function(t, e) {
        ...
        for (n = 0; n < r.length; n++)
          (i = r[n].clone()) instanceof $e &&
            (e.mutateSingle(i), s.push.apply(s, i.buildInstances()));
        return new Je(s);
      },
      freeze: function() {
  ...
  var Ye = {
    ...
    je = (Wt.BusinessHourGenerator = dt.extend({
      ...
      buildEventInstanceGroup: function(t, e) {
        ...
        if (i.length)
          return (n = new Je(xt(i, e))), (n.explicitEventDef = i[0]), n;
      },
      buildEventDefs: function(e) {
        var n,
          i = this.rawComplexDef,
          r = [],
          s = !1,
          o = [];
        for (
          ...
          (s && !r[n].dow) || o.push(this.buildEventDef(e, r[n]));
        return o;
      },
      buildEventDef: function(e, n) {
        var i = t.extend({}, Ye, n);
        return (
          e && ((i.start = null), (i.end = null)),
          Xe.parse(i, new on(this.calendar))
        );
      }
    })),
    Ze = {
    ...
    Qe = (Wt.EventDef = dt.extend(oe, {
      ...
      clone: function() {
        ...
        return (
          ...
          (e.rawId = this.rawId),
          (e.uid = this.uid),
          Qe.copyVerbatimStandardProps(this, e),
      ...
      applyManualStandardProps: function(e) {
        return (
          null != e.id
            ? (this.id = Qe.normalizeId((this.rawId = e.id)))
            : (this.id = Qe.generateId()),
          null != e._id
            ? (this.uid = String(e._id))
            : (this.uid = Qe.generateId()),
  ...
  (Qe.defineStandardProps = ae),
    (Qe.copyVerbatimStandardProps = le),
    (Qe.uuid = 0),
    (Qe.normalizeId = function(t) {
      return String(t);
    }),
  ...
  var Xe = Qe.extend({
    ...
    clone: function() {
      ...
      return (
        n.startTime && (n.startTime = e.duration(this.startTime)),
    ...
    applyProps: function(t) {
      ...
      return (
        t.start && (this.startTime = e.duration(t.start)),
  ...
  var Ke = dt.extend({
      ...
      toLegacy: function() {
        var t = this.dateProfile,
          e = this.def.toLegacy();
        return (
          (e.start = t.start.clone()), (e.end = t.end ? t.end.clone() : null), e
        );
      }
    }),
  ...
  (tn.isStandardProp = function(t) {
    ...
    (tn.parse = function(t, e) {
      ...
      return (
        !!s.isValid() &&
        (!o || (o.isValid() && o.isAfter(s)) || (o = null),
        null == a &&
          null == (a = e.allDayDefault) &&
          (a = r.opt("allDayDefault")),
        !0 === a
          ? (s.stripTime(), o && o.stripTime())
          : !1 === a &&
            (s.hasTime() || s.time(0), o && !o.hasTime() && o.time(0)),
        !o && l && (o = r.getDefaultEventEnd(!s.hasTime(), s)),
        new tn(s, o, r))
      );
    });
  var en = dt.extend({
      ...
      mutateSingle: function(t) {
        ...
        return (
          ...
          null != this.eventDefId &&
            (t.id = Qe.normalizeId((t.rawId = this.eventDefId))),
          this.className && (t.className = this.className),
          this.verbatimStandardProps &&
            $e.copyVerbatimStandardProps(this.verbatimStandardProps, t),
  ...
  rn.createFromRawProps = function(t, e, n) {
    ...
    for (i in e)
      tn.isStandardProp(i)
        ...
        : a.isStandardProp(i)
        ? (u[i] = e[i])
        : a.miscProps[i] !== e[i] && (c[i] = e[i]);
    return (
      (r = tn.parse(l, a.source)),
      r && (s = sn.createFromDiff(t.dateProfile, r, n)),
      u.id !== a.id && (d = u.id),
      J(u.className, a.className) || (f = u.className),
      Qe.copyVerbatimStandardProps(u, h),
      (o = new rn()),
      (o.eventDefId = d),
      (o.className = f),
      (o.verbatimStandardProps = h),
      (o.miscProps = c),
      s && (o.dateMutation = s),
      o
    );
  ...
  var sn = dt.extend({
    ...
    buildNewDateProfile: function(t, e) {
      ...
      return (
        t.end && !this.clearEnd
          ? (i = t.end.clone())
          : this.endDelta && !i && (i = e.getDefaultEventEnd(t.isAllDay(), n)),
        this.forceTimed
          ? ((r = !0), n.hasTime() || n.time(0), i && !i.hasTime() && i.time(0))
          : this.forceAllDay &&
            (n.hasTime() && n.stripTime(), i && i.hasTime() && i.stripTime()),
        this.dateDelta &&
          ((r = !0), n.add(this.dateDelta), i && i.add(this.dateDelta)),
        this.endDelta && ((r = !0), i.add(this.endDelta)),
        this.startDelta && ((r = !0), n.add(this.startDelta)),
        r && ((n = e.applyTimezone(n)), i && (i = e.applyTimezone(i))),
        !i &&
  ...
  sn.createFromDiff = function(t, e, n) {
    ...
    return (
      (r = i(e.start, t.start)),
      e.end &&
        ((s = i(e.unzonedRange.getEnd(), t.unzonedRange.getEnd())),
        (o = s.subtract(r))),
      (a = new sn()),
      (a.clearEnd = l),
      (a.forceTimed = u),
  ...
  var on = dt.extend(oe, {
    ...
    applyManualStandardProps: function(e) {
      return (
        null != e.id && (this.id = on.normalizeId(e.id)),
        t.isArray(e.className)
  ...
  (on.defineStandardProps = ae),
    (on.uuid = 0),
    (on.normalizeId = function(t) {
  ...
  ln.defineStandardProps({ events: !1 }),
    (ln.parse = function(e, n) {
      var i;
      return (
        t.isArray(e.events) ? (i = e) : t.isArray(e) && (i = { events: e }),
        !!i && on.parse.call(this, i, n)
      );
    }),
    an.registerClass(ln),
    (Wt.ArrayEventSource = ln);
  var un = on.extend({
    func: null,
    fetch: function(t, e, n) {
      var i = this;
  ...
  un.defineStandardProps({ events: !1 }),
    (un.parse = function(e, n) {
      var i;
      return (
        t.isFunction(e.events)
          ? (i = e)
          : t.isFunction(e) && (i = { events: e }),
        !!i && on.parse.call(this, i, n)
      );
    }),
    an.registerClass(un),
    (Wt.FuncEventSource = un);
  var cn = on.extend({
    url: null,
    startParam: null,
    endParam: null,
    ...
    fetch: function(e, n, i) {
      ...
      return (
        this.calendar.pushLoading(),
        ce.construct(function(e, n) {
          t.ajax(
            t.extend({ url: this.url }, cn.AJAX_DEFAULTS, s, {
              data: l,
              success: function(i) {
                var s;
    ...
    applyMiscProps: function(t) {
      on.prototype.applyMiscProps.apply(this, arguments),
        (this.ajaxSettings = t);
    }
  });
  (cn.AJAX_DEFAULTS = { dataType: "json", cache: !1 }),
    ...
    dn = (Wt.Theme = dt.extend({
      ...
      processIconOverride: function() {
        this.iconOverrideOption &&
          this.setIconOverride(this.optionsModel.get(this.iconOverrideOption));
      },
  ...
  var vn = xe.extend({
      ...
      renderFillRow: function(e, n) {
        var i,
          ...
          l = n.rightCol + 1;
        return (
          (i = "businessHours" === e ? "bgevent" : e.toLowerCase()),
          (r = t(
            '<div class="fc-' + i + '-skeleton"><table><tr/></table></div>'
          )),
          (s = r.find("tr")),
          a > 0 && s.append('<td colspan="' + a + '"/>'),
          s.append(n.el.attr("colspan", l - a)),
          l < o && s.append('<td colspan="' + (o - l) + '"/>'),
          this.component.bookendCells(s),
          r
        );
      }
    }),
      ...
      renderSegRow: function(e, n) {
        function i(e) {
          for (; o < e; )
            (c = (m[r - 1] || [])[o]),
              c
                ? c.attr("rowspan", parseInt(c.attr("rowspan") || 1, 10) + 1)
                : ((c = t("<td/>")), a.append(c)),
              (v[r][o] = c),
              (m[r][o] = c),
              o++;
              ...
              for (
                u = s[l],
                  ...
                  u.leftCol != u.rightCol
                    ? c.attr("colspan", u.rightCol - u.leftCol + 1)
                    : (m[r][o] = c);
                o <= u.rightCol;
      ...
      fgSegHtml: function(t, e) {
        ...
        return (
          ...
          t.isStart &&
            ...
            (d = '<span class="fc-time">' + et(n) + "</span>"),
          (i =
            '<span class="fc-title">' +
            (et(s.title || "") || "&nbsp;") +
            "</span>"),
    ...
    yn = Pe.extend({
      renderSegs: function(e, n) {
        var i,
          r = [];
        return (
          (i = this.eventRenderer.renderSegRows(e)),
          this.component.rowEls.each(function(e, s) {
            var o,
              a,
              l = t(s),
            ...
            n && n.row === e
              ? (a = n.el.position().top)
              : ((o = l.find(".fc-content-skeleton tbody")),
                o.length || (o = l.find(".fc-content-skeleton table")),
                (a = o.position().top)),
              u
                .css("top", a)
                .find("table")
    ...
    wn = (Wt.DayGrid = ke.extend(Ie, Be, {
      ...
      renderGrid: function() {
        ...
        for (
          ...
          s += this.renderDayRowHtml(t, this.isRigid);
        for (
          this.el.html(s),
            this.rowEls = this.el.find(".fc-row"),
            this.cellEls = this.el.find(".fc-day, .fc-disabled-day"),
            this.rowCoordCache = new ge({ els: this.rowEls, isVertical: !0 }),
      ...
      renderNumberCellHtml: function(t) {
        ...
        return o || this.cellWeekNumbersVisible
      ...
      unrenderEvents: function() {
        this.removeSegPopover(),
          ke.prototype.unrenderEvents.apply(this, arguments);
      },
      getOwnEventSegs: function() {
        return ke.prototype.getOwnEventSegs
      ...
      renderDrag: function(t, e, n) {
        ...
        if (t.length && e && e.component !== this)
          return this.helperRenderer.renderEventDraggingFootprints(t, e, n), !0;
      },
  ...
  wn.mixin({
    ...
    computeRowLevelLimit: function(e) {
      ...
      for (i = 0; i < l.length; i++)
        if (
          ((r = l.eq(i).removeClass("fc-limited")),
          (s = 0),
    ...
    limitRow: function(e, n) {
      function i(i) {
        for (; E < i; )
          (u = w.getCellSegs(e, E, n)),
            u.length &&
              ((d = s[n - 1][E]),
              (y = w.renderMoreLink(e, E, u)),
              (m = t("<div/>").append(y)),
              d.append(m),
              b.push(m[0])),
            E++;
      ...
      if (n && n < D.segLevels.length) {
        for (
          ...
          for (l = r[a], i(l.leftCol), h = [], c = 0; E <= l.rightCol; )
            (u = this.getCellSegs(e, E, n)), h.push(u), (c += u.length), E++;
          if (c) {
            for (
              d = s[n - 1][l.leftCol],
                f = d.attr("rowspan") || 1,
      ...
      return t('<a class="fc-more"/>')
        ...
        .on("click", function(o) {
          ...
          "function" == typeof a &&
            ...
            "popover" === a
              ? r.showSegPopover(e, n, u, d)
              : "string" == typeof a && s.calendar.zoomTo(l, a);
        });
    },
    showSegPopover: function(t, e, n, i) {
      ...
      (r = 1 == this.rowCnt ? a.el : this.rowEls.eq(t)),
        (s = {
          ...
          hide: function() {
            o.popoverSegs && o.triggerBeforeEventSegsDestroyed(o.popoverSegs),
        ...
        this.isRTL
          ? (s.right = l.offset().left + l.outerWidth() + 1)
          : (s.left = l.offset().left - 1),
        (this.segPopover = new fe(s)),
    ...
    renderSegPopoverContent: function(e, n, i) {
      var r,
        ...
        l = t(
          '<div class="fc-header ' +
            o.getClass("popoverHeader") +
            '"><span class="fc-close ' +
            o.getIconClass("close") +
      ...
      for (
        i = this.eventRenderer.renderFgSegEls(i, !0),
          this.popoverSegs = i,
          r = 0;
        r < i.length;
        r++
    ...
    resliceDaySegs: function(t, e) {
      var n,
        ...
        o = [];
      for (n = 0; n < t.length; n++)
        o.push.apply(o, this.eventFootprintToSegs(t[n].footprint, s));
  ...
  var Dn = (Wt.BasicView = Ae.extend({
        ...
        Ae.apply(this, arguments),
          ...
          this.opt("weekNumbers") &&
            (this.opt("weekNumbersWithinDays")
              ? ((this.dayGrid.cellWeekNumbersVisible = !0),
                (this.dayGrid.colWeekNumbersVisible = !1))
              : ((this.dayGrid.cellWeekNumbersVisible = !1),
                (this.dayGrid.colWeekNumbersVisible = !0))),
          this.addChild(this.dayGrid),
          (this.scroller = new we({ overflowX: "hidden", overflowY: "auto" }));
      },
      ...
      executeDateRender: function(t) {
        (this.dayGrid.breakOnWeeks = /year|month|week/.test(
          ...
          Ae.prototype.executeDateRender.apply(this, arguments);
      },
      renderSkeleton: function() {
        var e, n;
        this.el.addClass("fc-basic-view").html(this.renderSkeletonHtml()),
          this.scroller.render(),
          (e = this.scroller.el.addClass("fc-day-grid-container")),
      ...
      updateSize: function(t, e, n) {
        ...
        if (!this.dayGrid.rowEls)
          return void (
            e ||
            ((s = this.computeScrollerHeight(t)), this.scroller.setHeight(s))
          );
        Ae.prototype.updateSize.apply(this, arguments),
    ...
    bn = {
      ...
      renderIntroHtml: function() {
        var t = this.view;
        return this.colWeekNumbersVisible
          ? '<td class="fc-week-number" ' + t.weekNumberStyleAttr() + "></td>"
          : "";
      },
      getIsNumbersVisible: function() {
        return (
          wn.prototype.getIsNumbersVisible.apply(this, arguments) ||
    ...
    En = (Wt.MonthView = Dn.extend({
      buildRenderRange: function(t, e, n) {
        var i,
          r = Dn.prototype.buildRenderRange.apply(this, arguments),
          s = this.calendar.msToUtcMoment(r.startMs, n),
          o = this.calendar.msToUtcMoment(r.endMs, n);
        return (
          this.isFixedWeeks() &&
            ((i = Math.ceil(o.diff(s, "weeks", !0))), o.add(6 - i, "weeks")),
          new Ue(s, o)
        );
      },
      setGridHeight: function(t, e) {
  ...
  (_t.basic = { class: Dn }),
    (_t.basicDay = { type: "basic", duration: { days: 1 } }),
    (_t.basicWeek = { type: "basic", duration: { weeks: 1 } }),
    (_t.month = {
      class: En,
      duration: { months: 1 },
    ...
    Cn = He.extend({
      ...
      fgSegHtml: function(t, e) {
        ...
        if (
          ...
          s.isMultiDayRange(a.unzonedRange))
        ) {
          if (t.isStart || t.isEnd) {
            var p = o.msToMoment(t.startMs),
              v = o.msToMoment(t.endMs);
            (n = this._getTimeText(p, v, l)),
              (i = this._getTimeText(p, v, l, "LT")),
              (r = this._getTimeText(p, v, l, null, !1));
          }
        } else
          (n = this.getTimeText(t.footprint)),
        ...
        return (
          ...
          (n
            ? '<div class="fc-time" data-start="' +
              ...
              "</span></div>"
            : "") +
          (u.title ? '<div class="fc-title">' + et(u.title) + "</div>" : "") +
          '</div><div class="fc-bg"/>' +
      ...
      generateFgSegHorizontalCss: function(t) {
        ...
        return (
          ...
          this.timeGrid.isRTL ? ((e = 1 - s), (n = r)) : ((e = r), (n = 1 - s)),
          (o.zIndex = t.level + 1),
          (o.left = 100 * e + "%"),
          (o.right = 100 * n + "%"),
          i &&
    ...
    Tn = (Wt.TimeGrid = ke.extend(Ie, Be, {
      ...
      computeLabelInterval: function(t) {
        ...
        for (n = Pn.length - 1; n >= 0; n--)
          if (((i = e.duration(Pn[n])), (r = U(i, t)), at(r) && r > 1))
            return i;
        return e.duration(t);
      },
      renderDates: function(t) {
      ...
      renderSlats: function() {
        ...
        (this.slatContainerEl = this.el
          ...
          (this.slatCoordCache = new ge({ els: this.slatEls, isVertical: !0 }));
      },
      renderSlatRowHtml: function() {
        for (
          var t,
            ...
            l = this.dateProfile,
            u = "",
            c = e.duration(+l.minTime),
            h = e.duration(0);
          c < l.maxTime;

        )
          (t = s.msToUtcMoment(l.renderUnzonedRange.startMs).time(c)),
            (n = at(U(h, this.labelInterval))),
            (i =
              ...
              r.axisStyleAttr() +
              ">" +
              (n ? "<span>" + et(t.format(this.labelFormat)) + "</span>" : "") +
              "</td>"),
            (u +=
              '<tr data-time="' +
              t.format("HH:mm:ss") +
      ...
      renderColumns: function() {
        ...
        (this.dayRanges = this.dayDates.map(function(e) {
          ...
          (this.colCoordCache = new ge({ els: this.colEls, isHorizontal: !0 })),
      ...
      renderNowIndicator: function(e) {
        var n,
          i = this.componentFootprintToSegs(
            new We(new Ue(e, e.valueOf() + 1), !1)
          ),
          r = this.computeDateTop(e, e),
          s = [];
        for (n = 0; n < i.length; n++)
          s.push(
            t('<div class="fc-now-indicator fc-now-indicator-line"></div>')
              .css("top", r)
              .appendTo(this.colContainerEls.eq(i[n].col))[0]
          );
        i.length > 0 &&
          s.push(
            t('<div class="fc-now-indicator fc-now-indicator-arrow"></div>')
              .css("top", r)
    ...
    In = (Wt.AgendaView = Ae.extend({
      ...
      renderSkeleton: function() {
        ...
        this.el.addClass("fc-agenda-view").html(this.renderSkeletonHtml()),
          this.scroller.render(),
          (e = this.scroller.el.addClass("fc-time-grid-container")),
      ...
      updateSize: function(t, e, n) {
        ...
        if (
          ...
          return void (
            e ||
            ((o = this.computeScrollerHeight(t)), this.scroller.setHeight(o))
          );
        ...
        this.timeGrid.bottomRuleEl.hide(),
          ...
          this.dayGrid &&
            ...
            s && "number" != typeof s && (s = xn),
            s && this.dayGrid.limitRows(s)),
          e ||
            ((o = this.computeScrollerHeight(t)),
            this.scroller.setHeight(o),
            (a = this.scroller.getScrollbarWidths()),
            (a.left || a.right) &&
              (i(l, a),
              (o = this.computeScrollerHeight(t)),
              this.scroller.setHeight(o)),
            this.scroller.lockOverflow(a),
      ...
      renderDrag: function(t, e, n) {
        ...
        return (
          ...
          this.dayGrid && (r = this.dayGrid.renderDrag(i.allDay, e, n) || r),
          r
        );
      },
      renderEventResize: function(t, e, n) {
  ...
  (_t.agenda = {
    ...
    (_t.agendaDay = { type: "agenda", duration: { days: 1 } }),
    (_t.agendaWeek = { type: "agenda", duration: { weeks: 1 } });
  var zn = (Wt.ListView = Ae.extend({
    ...
    renderDates: function(t) {
      for (
        ...
        r.push(n.clone()),
          s.push(new Ue(n, n.clone().add(1, "day"))),
          n.add(1, "day");
      ...
      for (e = 0; e < r.length; e++)
        if (
          ...
          !i.isEnd &&
            !t.isAllDay &&
            e + 1 < r.length &&
            t.unzonedRange.endMs < r[e + 1].startMs + this.nextDayThreshold)
        ) {
    ...
    eventPointingClass: Te.extend({
      handleClick: function(e, n) {
        var i;
        Te.prototype.handleClick.apply(this, arguments),
    ...
    renderSegList: function(e) {
      ...
      for (n = 0; n < s.length; n++)
        if ((i = s[n]))
          for (
            a.append(this.dayHeaderHtml(this.dayDates[n])),
              this.eventRenderer.sortEventSegs(i),
              r = 0;
            r < i.length;
            r++
          )
