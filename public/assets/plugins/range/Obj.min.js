function generateGUID() {
  do
    var e = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(
      e
    ) {
...
function Obj() {
  (this._parent = null),
    ...
    (this.on = function(e, n) {
      "function" == typeof e && void 0 === n && ((n = e), (e = "all")),
        (e = e.toLowerCase().split(" "));
      for (var t = 0; t < e.length; t++)
        this._handlers.push({ event: e[t], handler: n });
      return this;
    }),
    ...
    (this.offOnce = function(e, n) {
      if (void 0 === n && "function" == typeof e)
        for (var n = e, t = 0; t < this._onceHandlers.length; t++)
          this._onceHandlers[t].handler == n &&
            this._onceHandlers.splice(t--, 1);
      else if (void 0 === n && "string" == typeof e) {
        e = e.toLowerCase().split(" ");
        for (var t = 0; t < this._onceHandlers.length; t++)
          e.indexOf(this._onceHandlers[t].event) > -1 &&
            this._onceHandlers.splice(t--, 1);
      } else {
        e = e.toLowerCase().split(" ");
        for (var t = 0; t < this._onceHandlers.length; t++)
    ...
    (this.trigger = function(e, n) {
      ...
      for (var t = 0; t < this._handlers.length; t++)
        (e.indexOf(this._handlers[t].event) > -1 ||
          "all" == this._handlers[t].event) &&
          toFunc(this._handlers[t].handler).call(
            this,
            this._handlers[t].event,
            n
          );
      for (var t = 0; t < this._onceHandlers.length; t++)
        (e.indexOf(this._onceHandlers[t].event) > -1 ||
          "all" == this._handlers[t].event) &&
          (toFunc(this._onceHandlers[t].handler).call(
            this,
            this._onceHandlers[t].event,
            n
          ),
          this._onceHandlers.splice(t--, 1));
      return this;
    ...
    (this.refresh = function() {
      for (var e = $(), n = 0; n < this._elements.length; n++) {
        ...
        i
          ? (i.attr("guid", this.guid),
            (this._elements = this._elements.not(t)),
            t.after(i),
            t.remove(),
            (e = e.add(i)))
          : (e = e.add(t));
    ...
    (this.destroy = function() {
      var e = this;
      return (
        this._elements.each(function(n, t) {
          var i = $(t);
