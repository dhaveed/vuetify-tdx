  ...
  var bootstrapWizardCreate = function(element, options) {
    ...
    this.next = function(e) {
      ...
      if ($index > obj.navigationLength()) {
        ...
        $navigation
          .find(baseItemSelector + ":eq(" + $index + ") a")
          .tab("show");
      }
    };
    ...
    this.show = function(index) {
      if (isNaN(index)) {
        return element
          .find(baseItemSelector + " a[href=#" + index + "]")
          .tab("show");
      } else {
        return element
          .find(baseItemSelector + ":eq(" + index + ") a")
    ...
    var innerTabClick = function(e) {
      ...
      var clickedIndex = $navigation
        .find(baseItemSelector)
        .index($(e.currentTarget).parent(baseItemSelector));
      if (
        $settings.onTabClick &&
        ...
        t.fn.ripples && this.options.ripples && this.ripples(),
          ...
          document.arrive &&
            ...
            this.options.checkbox &&
              i.arrive(this.options.checkboxElements, function() {
            ...
            this.options.togglebutton &&
              i.arrive(this.options.togglebuttonElements, function() {
